...
pure_all :: $(INST_SCRIPT)/fascomp $(INST_SCRIPT)/fassort $(INST_SCRIPT)/fascut $(INST_SCRIPT)/fascodon $(INST_SCRIPT)/fasgrep $(INST_SCRIPT)/fasconvert $(INST_SCRIPT)/fastr $(INST_SCRIPT)/gbfeat2fas $(INST_SCRIPT)/alndegap $(INST_SCRIPT)/fasfilter $(INST_SCRIPT)/fasxl $(INST_SCRIPT)/gbgrep $(INST_SCRIPT)/fasrc $(INST_SCRIPT)/gbalncut $(INST_SCRIPT)/alnpi $(INST_SCRIPT)/fastaxsort $(INST_SCRIPT)/fastax $(INST_SCRIPT)/alnseg $(INST_SCRIPT)/fassub $(INST_SCRIPT)/faslen $(INST_SCRIPT)/fasuniq
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)/fascomp $(INST_SCRIPT)/fassort \
	  $(INST_SCRIPT)/fascut $(INST_SCRIPT)/fascodon \
	  $(INST_SCRIPT)/fasgrep $(INST_SCRIPT)/fasconvert \
	  $(INST_SCRIPT)/fastr $(INST_SCRIPT)/gbfeat2fas \
	  $(INST_SCRIPT)/alndegap $(INST_SCRIPT)/fasfilter \
	  $(INST_SCRIPT)/fasxl $(INST_SCRIPT)/gbgrep \
	  $(INST_SCRIPT)/fasrc $(INST_SCRIPT)/gbalncut \
	  $(INST_SCRIPT)/alnpi $(INST_SCRIPT)/fastaxsort \
	  $(INST_SCRIPT)/fastax $(INST_SCRIPT)/alnseg \
	  $(INST_SCRIPT)/fassub $(INST_SCRIPT)/faslen \
	  $(INST_SCRIPT)/fasuniq 
