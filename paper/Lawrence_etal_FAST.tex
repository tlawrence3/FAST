...
(specifically, a restriction of BioPerl FastA format). Additionally, FAST
has an option that allows the use of Sanger and Illumina 1.8+ FASTQ
formatted files. Compared to software already available, FAST is 
distinguished by consistency in interface design across utilities, 
conformance with Unix philosophy,and the portability, ease of installation, 
and security inherent in its BioPerl and Perl foundations. 
FAST workflows reduce manual interventions in data processing and facilitate 
the interactive investigation and control of data by its users. Bringing all the
