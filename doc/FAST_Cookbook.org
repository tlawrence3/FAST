...
*** Degapping sites with =fastr= ## THIS HAS COMPLETELY CHANGED. IS THERE ANOTHER FUNCTION TO DO THIS IF ALNDEGAP IS NO LONGER AN OPTION

=fastr= also allows for editing of alignments based on their gap
...
#+BEGIN_SRC shell
fastr --degap t/data/P450.clustalw2.fas | faslen | head -1 | cut -f2 -d" "
#+END_SRC
