#
# BioPerl module for FAST::Bio::Event::EventHandlerI
#
...
illustrated by the FAST::Bio::SearchIO system, where many different formats
exist for sequence similarity and pairwise sequence alignment exist
that essentially all result in FAST::Bio::Search objects.
...
package FAST::Bio::Event::EventHandlerI;
use strict;
use Carp;
