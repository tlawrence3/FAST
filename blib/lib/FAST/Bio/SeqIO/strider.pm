# BioPerl module for FAST::Bio::SeqIO::strider
#
...
This object can transform FAST::Bio::Seq objects to and from strider
...
Modelled after FAST::Bio::SeqIO::fasta by Ewan Birney E<lt>birney@ebi.ac.ukE<gt> and
...
package FAST::Bio::SeqIO::strider;
use strict;
use warnings;
...
sub _initialize {
  ...
  unless ( defined $self->sequence_factory ) {
    $self->sequence_factory(FAST::Bio::Seq::SeqFactory->new(-verbose => $self->verbose(), 
