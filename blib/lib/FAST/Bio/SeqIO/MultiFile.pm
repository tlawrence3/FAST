#
# BioPerl module for FAST::Bio::SeqIO::MultiFile
#
...
FAST::Bio::SeqIO::MultiFile provides a simple way of bundling a whole
...
package FAST::Bio::SeqIO::MultiFile;
use strict;
...
sub _load_file{
   ...
   my $seqio = FAST::Bio::SeqIO->new( '-format' => $self->_format(), -file => $file);
