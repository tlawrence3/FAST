#
# BioPerl module for FAST::Bio::SeqIO::asciitree
#
...
=head1 SYNOPSIS
  ...
  # rather go through the SeqIO handler system. Go:
    ...
    $instream  = FAST::Bio::SeqIO->new(-file => $filename,
                                 -format => 'chadoxml');
...
This is a WRITE-ONLY SeqIO module. It writes a FAST::Bio::SeqI object
...
package FAST::Bio::SeqIO::asciitree;
use strict;
...
sub _locstr {
    ...
    my $splitlocstr = '';
    if ($sf->isa("FAST::Bio::SeqFeatureI")) {
        my @locs = ($sf->location);
