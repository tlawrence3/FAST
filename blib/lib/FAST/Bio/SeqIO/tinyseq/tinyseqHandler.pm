# BioPerl module for FAST::Bio::SeqIO::tinyseqHandler
#
...
package FAST::Bio::SeqIO::tinyseq::tinyseqHandler;
...
=head2 new
  ...
  Title		: new
  Usage		: $handler = FAST::Bio::SeqIO::tinyseq::tinyseqHandler->new()
  Function	: instantiates a tinyseqHandler for use by
                  XML::Parser::PerlSAX
  Returns	: FAST::Bio::SeqIO::tinyseq::tinyseqHandler object
  Args		: NONE
...
=head2 TSeq
  ...
  Returns	: loh of parsed sequence atts for FAST::Bio::SeqIO::tinyseq
  Args		: NONE
