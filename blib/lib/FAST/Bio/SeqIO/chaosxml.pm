#
# BioPerl module for FAST::Bio::SeqIO::chaosxml
#
...
See L<FAST::Bio::SeqIO::chaos> for a full description
...
package FAST::Bio::SeqIO::chaosxml;
use strict;

use Data::Stag::XMLWriter;

use base qw(FAST::Bio::SeqIO::chaos);
