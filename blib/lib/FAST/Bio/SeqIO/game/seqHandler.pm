#
# BioPerl module for FAST::Bio::SeqIO::game::seqHandler
#
...
FAST::Bio::SeqIO::game::seqHandler processes all of the sequences associated with a game record
...
package FAST::Bio::SeqIO::game::seqHandler;

use Data::Dumper;

use FAST::Bio::SeqIO::game::featHandler;
...
=head2 new
 ...
 Title   : new
 Usage   : my $seqHandler = FAST::Bio::SeqIO::game::seqHandler->new($seq, $ann, $comp, $map, $src )
...
=head2 convert
 ...
 Function: converts the main XML sequence element and associated annotations to FAST::Bio::
...
sub _add_seq {
    ...
    if ($el->{_organism}) {
	    ...
	    my $species = FAST::Bio::Species->new( -classification => [reverse @organism] );
	    $seq->species($species);
	}
    }
...
#	my $species = FAST::Bio::Species->new( -classification => [ reverse @class ],
...
sub _annotation {
    ...
    # 'transposable element' is too long (breaks FAST::Bio::SeqIO::GenBank)
...
=head2 _seq
 ...
 Returns : a FAST::Bio::RichSeq object
 Args    : a sequence ID
...
sub _seq {
	...
	$seq = FAST::Bio::Seq::RichSeq->new( -id => $id );
...
=head2 _feat_handler
 ...
 Returns : a FAST::Bio::SeqIO::game::featHandler object
 Args    : none
...
sub _feat_handler {
	...
	$handler = FAST::Bio::SeqIO::game::featHandler->new( @args );
