#
# BioPerl module for FAST::Bio::Factory::ObjectFactory
#
...
This object will build L<FAST::Bio::Root::RootI> objects generically.
...
package FAST::Bio::Factory::ObjectFactory;
use strict;
...
sub new {
    ...
    $self->{'_loaded_types'} = {};
    $self->interface($interface || "FAST::Bio::Root::RootI");
