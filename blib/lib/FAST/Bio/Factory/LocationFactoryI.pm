#
# BioPerl module for FAST::Bio::Factory::LocationFactoryI
#
...
An interface for Location Factories which generate FAST::Bio::LocationI
...
package FAST::Bio::Factory::LocationFactoryI;
use strict;
use Carp;
