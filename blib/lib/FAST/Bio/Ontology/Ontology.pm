#
# BioPerl module for FAST::Bio::Ontology::Ontology
#
...
=head1 SYNOPSIS
    ...
    use FAST::Bio::Ontology::Ontology;
    use FAST::Bio::Ontology::Term;

    # create ontology object
    my $ont = FAST::Bio::Ontology::Ontology->new(-name => "OBF");

    # add terms, relationships ...
    my $bp = FAST::Bio::Ontology::Term->new(-identifier => '02', -name => "Bioperl");
    my $obf = FAST::Bio::Ontology::Term->new(-identifier => '01', -name => "OBF");
    my $partof = FAST::Bio::Ontology::RelationshipType->get_instance("PART_OF");
    $ont->add_term($bp);
    $ont->add_term($obf);
    ...
    my $ont2 = FAST::Bio::Ontology::Ontology->new(-name => "Foundations",
                                            -engine => $ont->engine());


=head1 DESCRIPTION

This is a no-frills implementation of L<FAST::Bio::Ontology::OntologyI>.
...
package FAST::Bio::Ontology::Ontology;
use strict;

# Object preamble - inherits from FAST::Bio::Root::Root

#use FAST::Bio::Ontology::SimpleOntologyEngine; # loaded dynamically now!

use base qw(FAST::Bio::Root::Root FAST::Bio::Ontology::OntologyI FAST::Bio::AnnotatableI);

=head2 new

 Title   : new
 Usage   : my $obj = FAST::Bio::Ontology::Ontology->new();
 Function: Builds a new FAST::Bio::Ontology::Ontology object
 Returns : an instance of FAST::Bio::Ontology::Ontology
 Args    : any number of named arguments. The following names will be
           recognized by this module:
            ...
            -engine       the FAST::Bio::Ontology::OntologyEngineI
                          implementation that this instance should use;
                          default is FAST::Bio::Ontology::SimpleOntologyEngine
...
=head1 Methods from L<FAST::Bio::Ontology::OntologyI>
...
=head2 engine
 ...
 Function: Get/set the ontology engine to which all the query methods
           delegate.
 Example :
 Returns : an object implementing FAST::Bio::Ontology::OntologyEngineI
 Args    : on set, new value (an object implementing
           FAST::Bio::Ontology::OntologyEngineI, or  undef)

See L<FAST::Bio::Ontology::OntologyEngineI>.
...
sub engine{
    ...
    if (@_) {
        ...
        if($engine &&
           (! (ref($engine) &&
               $engine->isa("FAST::Bio::Ontology::OntologyEngineI")))) {
        ...
        eval {
            ...
            require FAST::Bio::Ontology::SimpleOntologyEngine;
        };
        if ($@) {
        ...
        $self->{'engine'} = FAST::Bio::Ontology::SimpleOntologyEngine->new();
    }
    return $self->{'engine'};
}

=head1 Methods defined in L<FAST::Bio::Ontology::OntologyEngineI>
...
sub add_relationship {
  ...
  if($rel && $rel->isa("FAST::Bio::Ontology::TermI")) {
    # we need to construct the relationship object on the fly
    my ($predicate,$object) = @_;
    $rel = FAST::Bio::Ontology::Relationship->new(
                                            -subject_term   => $rel,
                                            -object_term    => $object,
...
=head2 get_relationships
 ...
 Example :
 Returns : Array of FAST::Bio::Ontology::RelationshipI objects
 Args    : Optionally, a FAST::Bio::Ontology::TermI compliant object
...
sub get_predicate_terms{
    ...
    # skipped FAST::Bio::Ontology::Relationship w/o defined Ontology (bug 2573)
...
=head2 annotation
 ...
 Function: Get/Set the FAST::Bio::Annotation::Collection object
           The collection contains FAST::Bio::Annotation::SimpleValue
           objects to store header information like the version
           and date present in the header section of an Ontology
           file.

 Example :
 Returns : value of annotation (a FAST::Bio::Annotation::Collection
           compliant object)
 Args    : A FAST::Bio::Annotation::Collection object (Optional)
