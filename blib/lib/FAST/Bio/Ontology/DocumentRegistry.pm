#
# BioPerl module for FAST::Bio::Ontology::DocumentRegistry
#
...
Do not use this directly, use FAST::Bio::Ontology::OntologyStore instead.
FAST::Bio::Ontology::OntologyStore uses FAST::Bio::Ontology::DocumentRegistry to
load and cache ontologies as object graphs, you can just ask it for
what you want by name.  See L<FAST::Bio::Ontology::OntologyStore> for
details.
...
package FAST::Bio::Ontology::DocumentRegistry;
use strict;
