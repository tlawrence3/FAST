#
# BioPerl module for FAST::Bio::Ontology::RelationshipType  
#
...
This class extends L<FAST::Bio::Ontology::Term>, so it essentially is-a
L<FAST::Bio::Ontology::TermI>. In addition, all methods are overridden such
...
package FAST::Bio::Ontology::RelationshipType;
use strict;
...
use base qw(FAST::Bio::Ontology::Term);
...
=head2 get_instance
 ...
 Title   : get_instance
 Usage   : $IS_A       = FAST::Bio::Ontology::RelationshipType->get_instance( "IS_A" );
           $PART_OF    = FAST::Bio::Ontology::RelationshipType->get_instance( "PART_OF" );
           $RELATED_TO = FAST::Bio::Ontology::RelationshipType->get_instance( "RELATED_TO" );
           $CONTAINS   = FAST::Bio::Ontology::RelationshipType->get_instance( "CONTAINS" );
           $FOUND_IN   = FAST::Bio::Ontology::RelationshipType->get_instance( "FOUND_IN" );
 ...
 Args    : "IS_A" or "PART_OF" or "CONTAINS" or "FOUND_IN" or 
           "RELATED_TO" [scalar]
           the ontology [FAST::Bio::Ontology::OntologyI] (optional)
...
=head2 equals
 ...
 Args    : [FAST::Bio::Ontology::RelationshipType]
...
sub equals {
    ...
    $self->_check_class( $type, "FAST::Bio::Ontology::RelationshipType" );
...
=head2 ontology
 ...
 Returns : The ontology [FAST::Bio::Ontology::OntologyI].
 Args    : On set, the ontology [FAST::Bio::Ontology::OntologyI] (optional).
