#
# BioPerl module for FAST::Bio::Ontology::SimpleOntologyEngine
#
...
=head1 SYNOPSIS
  ...
  my $soe = FAST::Bio::Ontology::SimpleOntologyEngine->new;

=head1 DESCRIPTION

This is a "simple" implementation of FAST::Bio::Ontology::OntologyEngineI.
...
package FAST::Bio::Ontology::SimpleOntologyEngine;
use strict;
use Carp;
...
=head2 new
 ...
 Title   : new
 Usage   : $soe = FAST::Bio::Ontology::SimpleOntologyEngine->new;
 Function: Initializes the ontology engine.
 Example : $soe = FAST::Bio::Ontology::SimpleOntologyEngine->new;
...
sub new {
    ...
    $self->relationship_factory(
        FAST::Bio::Ontology::RelationshipFactory->new( -type => "FAST::Bio::Ontology::Relationship" ) );
    return $self;
}
...
=head2 _term_store
 ...
 Function:
 Example :
 Returns : reference to an array of FAST::Bio::Ontology::TermI objects
 Args    : reference to an array of FAST::Bio::Ontology::TermI objects
...
=head2 _relationship_type_store
 ...
 Function:
 Example :
 Returns : reference to an array of FAST::Bio::Ontology::RelationshipType objects
 Args    : reference to an array of FAST::Bio::Ontology::RelationshipType objects
...
sub get_child_terms {
    ...
    $self->throw("must provide TermI compliant object")
        unless defined($term) && $term->isa("FAST::Bio::Ontology::TermI");
...
=head2 _unique_termid
 ...
 Example :
 Returns : a string
 Args    : a FAST::Bio::Ontology::TermI compliant object
