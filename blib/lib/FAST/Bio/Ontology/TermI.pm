#
# BioPerl module for FAST::Bio::Ontology::Term
#
...
package FAST::Bio::Ontology::TermI;
use strict;
...
sub category {
	...
	# a TermI object
	my $arg = shift;
	$arg = $arg->name() if ref($arg) && $arg->isa("FAST::Bio::Ontology::TermI");
	...
	my $term;
	if(defined($ont)) {
	    $term = FAST::Bio::Ontology::Term->new(-name => $ont->name(),
