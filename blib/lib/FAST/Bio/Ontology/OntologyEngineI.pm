...
this minimalistic set of methods. Check modules in the FAST::Bio::Ontology
...
Ontology parsers in FAST::Bio::OntologyIO are required to return an
...
package FAST::Bio::Ontology::OntologyEngineI;
use strict;
use Carp;
...
=head2 get_relationships
 ...
 Args    : None, or a FAST::Bio::Ontology::TermI compliant object for which
...
=head2 relationship_factory
 ...
 Example : 
 Returns : value of relationship_factory (a FAST::Bio::Factory::ObjectFactory
           compliant object)
 Args    : 
...
=head2 term_factory
 ...
 Example : 
 Returns : value of term_factory (a FAST::Bio::Factory::ObjectFactory
           compliant object)
 Args    : 
...
=head2 common_ancestor_path
 ...
 Returns : The path of the first term to the common ancestor in scalar
           ...
           FAST::Bio::Ontology::PathI compliant objects.
 Args    : The two terms (FAST::Bio::Ontology::TermI objects), and optionally
           a constraining common predicate (FAST::Bio::Ontology::TermI object).
