...
#
#
# BioPerl module for FAST::Bio::DB::SeqI.pm
#
...
package FAST::Bio::DB::SeqI;
use strict;


use base qw(FAST::Bio::DB::RandomAccessI);

=head1 Methods inherieted from FAST::Bio::DB::RandomAccessI
...
=head1 Methods [that were] specific for FAST::Bio::DB::SeqI
