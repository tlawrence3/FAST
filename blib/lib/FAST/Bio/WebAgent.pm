#
# BioPerl module for FAST::Bio::WebAgent
#
...
copied from FAST::Bio::DB::WebDBSeqI: delay() and delay_policy. These are
...
package FAST::Bio::WebAgent;
use vars qw($LAST_INVOCATION_TIME);
use strict;

use base qw(LWP::UserAgent FAST::Bio::Root::Root);
