#
# BioPerl module for FAST::Bio::SeqAnalysisParserI
#
...
=head1 SYNOPSIS
    ...
    my $parser = FAST::Bio::Factory::SeqAnalysisParserFactory->get_parser(
...
See FAST::Bio::Factory::SeqAnalysisParserFactoryI and
FAST::Bio::Factory::SeqAnalysisParserFactory for interface and an implementation
...
package FAST::Bio::SeqAnalysisParserI;
use strict;
use Carp;
