#
# BioPerl module for FAST::Bio::Search::Result::GenericResult
#
...
=head1 SYNOPSIS
    ...
    my $io = FAST::Bio::SearchIO->new(-format => 'blast',
    ...
    use FAST::Bio::Search::Result::GenericResult;
    my @hits = (); # would be a list of FAST::Bio::Search::Hit::HitI objects
    # typically these are created from a FAST::Bio::SearchIO stream
    my $result = FAST::Bio::Search::Result::GenericResult->new
...
This object is an implementation of the FAST::Bio::Search::Result::ResultI
...
L<FAST::Bio::Search::Result::ResultI|FAST::Bio::Search::Result::ResultI>.
...
package FAST::Bio::Search::Result::GenericResult;
use strict;

use FAST::Bio::Search::GenericStatistics;
use FAST::Bio::Tools::Run::GenericParameters;

# bug #1420
#use overload 
#    '""' => \&to_string;

use base qw(FAST::Bio::Root::Root FAST::Bio::Search::Result::ResultI);

=head2 new

 Title   : new
 Usage   : my $obj = FAST::Bio::Search::Result::GenericResult->new();
 Function: Builds a new FAST::Bio::Search::Result::GenericResult object 
 Returns : FAST::Bio::Search::Result::GenericResult
 Args    : -query_name        => Name of query Sequence
           ...
           -hits              => array ref of FAST::Bio::Search::Hit::HitI objects
           ...
           -hit_factory       => FAST::Bio::Factory::ObjectFactoryI capable of making
                                 FAST::Bio::Search::Hit::HitI objects
...
sub new {
  ...
  $self->{'_hits'} = [];
  $self->{'_hitindex'} = 0;
  $self->{'_statistics'} = FAST::Bio::Search::GenericStatistics->new();
  $self->{'_parameters'} = FAST::Bio::Tools::Run::GenericParameters->new();
...
=head2 FAST::Bio::Search::Result::ResultI interface methods

FAST::Bio::Search::Result::ResultI implementation
...
=head2 FAST::Bio::Search::Report 

FAST::Bio::Search::Result::GenericResult specific methods
...
=head2 add_hit
 ...
 Args    : FAST::Bio::Search::Hit::HitI

=cut

sub add_hit {
    my ($self,$s) = @_;
    if (ref($s) eq 'HASH' || $s->isa('FAST::Bio::Search::Hit::HitI') ) {
        push @{$self->{'_hits'}}, $s;
    }
    else { 
        $self->throw("Passed in " .ref($s)." as a Hit which is not a FAST::Bio::Search::HitI.");
    }
...
See documentation in L<FAST::Bio::Search::Result::ResultI::no_hits_found()|FAST::Bio::Search::Result::ResultI>
...
See documentation in L<FAST::Bio::Search::Result::ResultI::set_no_hits_found()|FAST::Bio::Search::Result::ResultI>
