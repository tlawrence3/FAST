#
# BioPerl module FAST::Bio::Search::Hit::PullHitI
#
...
=head1 SYNOPSIS
    ...
    my $parser = FAST::Bio::SearchIO->new(-format => 'hmmer_pull',
...
that use FAST::Bio::PullParserI. It only really makes sense for PullHit modules to be
...
package FAST::Bio::Search::Hit::PullHitI;

use FAST::Bio::Search::SearchUtils;

use strict;

use base qw(FAST::Bio::PullParserI FAST::Bio::Search::Hit::HitI);
...
=head2 hsps
 ...
 Returns   : Array context : list of L<FAST::Bio::Search::HSP::BlastHSP> objects.
...
See Also   : L<FAST::Bio::Search::HSP::HSPI::seq_inds()|FAST::Bio::Search::HSP::HSPI>
...
See Also   : L<expect()|expect>, L<signif()|signif>,
             L<FAST::Bio::Search::BlastUtils::get_exponent()|FAST::Bio::Search::BlastUtils>
...
See Also   : L<FAST::Bio::Search::HSP::HSPI::strand>()
...
See Also   : L<length()|length>, L<frac_aligned_query()|frac_aligned_query>,
             ...
             L<FAST::Bio::Search::SearchUtils::tile_hsps()|FAST::Bio::Search::SearchUtils>,
             L<FAST::Bio::Search::HSP::BlastHSP::length()|FAST::Bio::Search::HSP::BlastHSP>
