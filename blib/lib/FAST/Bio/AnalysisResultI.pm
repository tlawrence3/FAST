#-----------------------------------------------------------------
#
# BioPerl module FAST::Bio::AnalysisResultI
#
# Please direct questions and support issues to <bioperl-l@bioperl.org> 
#
# Cared for by Steve Chervitz <sac@bioperl.org>
#
# Derived from FAST::Bio::Tools::AnalysisResult by Hilmar Lapp <hlapp@gmx.net>
#
...
FAST::Bio::AnalysisResultI defines an interface that must be implemented by
a subclass. So you cannot create FAST::Bio::AnalysisResultI objects,
only objects that inherit from FAST::Bio::AnalysisResultI. 
...
Email hlapp@gmx.net (author of FAST::Bio::Tools::AnalysisResult on which this module is based)
...
package FAST::Bio::AnalysisResultI;
use strict;
...
=head2 analysis_query
 ...
 Purpose   : Get a FAST::Bio::PrimarySeqI-compatible object representing the entity 
             on which the analysis was performed. Lacks sequence information.
 Argument  : n/a
 Returns   : A FAST::Bio::PrimarySeqI-compatible object without sequence information.
