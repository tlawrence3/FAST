#
# BioPerl module for FAST::Bio::OntologyIO
#
...
=head1 SYNOPSIS
    ...
    my $parser = FAST::Bio::OntologyIO->new(-format => "go",
                                      -file=> $file);
...
formats. Conceptually, it is very similar to L<FAST::Bio::SeqIO>, but the
...
=head2 new
 ...
 Title   : new
 Usage   : my $parser = FAST::Bio::OntologyIO->new(-format => 'go', @args);
 Function: Returns a stream of ontologies opened on the specified input
           for the specified format.
 Returns : An ontology parser (an instance of FAST::Bio::OntologyIO) initialized
           for the specified format.
 Args    : Named parameters. Common parameters are
              ...
              -format    - the format of the input; the following are
                  ...
                  interprosax: InterPro XML - this is actually not a
                          FAST::Bio::OntologyIO compliant parser; instead it
                          persists terms as they are encountered.
                          L<FAST::Bio::OntologyIO::Handlers::InterPro_BioSQL_Handler>
...
sub new {
    ...
    # object?
    if( $class =~ /FAST::Bio::OntologyIO::(\S+)/ ) {
        ...
        return "FAST::Bio::OntologyIO::$format"->new(@args);
    }
...
sub _initialize {
    ...
    # initialize the FAST::Bio::Root::IO part
...
=head2 next_ontology
 ...
 Returns : a L<FAST::Bio::Ontology::OntologyI> compliant object, or undef at the
           end of the stream
 Args    : none
...
sub _load_format_module {
    my ($self, $format) = @_;
    my $module = "FAST::Bio::OntologyIO::" . $format;
    my $ok;
