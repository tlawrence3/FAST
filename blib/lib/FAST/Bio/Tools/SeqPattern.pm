#
# bioperl module for FAST::Bio::Tools::SeqPattern
#
...
=head1 SYNOPSIS
 ...
 my $pattern1 = FAST::Bio::Tools::SeqPattern->new(-SEQ =>$pat1, -TYPE =>'Dna');

 my $pat2     = '[VILM]R(GXX){3,2}...[^PG]';
 my $pattern2 = FAST::Bio::Tools::SeqPattern->new(-SEQ =>$pat2, -TYPE =>'Amino');

=head1 DESCRIPTION

L<FAST::Bio::Tools::SeqPattern> module encapsulates generic data and
methods for manipulating regular expressions describing nucleic or
amino acid sequence patterns (a.k.a, "motifs").

L<FAST::Bio::Tools::SeqPattern> is a concrete class that inherits from L<FAST::Bio::Seq>.
...
A key motivation for L<FAST::Bio::Tools::SeqPattern> is to have a way to
...
is not handled properly by FAST::Bio::Tools::SeqPattern.pm, please
...
sequences as supported by L<FAST::Bio::Seq>. These ambiguity codes
...
L<FAST::Bio::Seq> - Lightweight sequence object.
...
package FAST::Bio::Tools::SeqPattern;

use base qw(FAST::Bio::Root::Root);
use strict;
use vars qw ($ID);
$ID  = 'FAST::Bio::Tools::SeqPattern';

## These constants may be more appropriate in a FAST::Bio::Dictionary.pm
## type of class.
my $PURINES      = 'AG';
my $PYRIMIDINES  = 'CT';
my $BEE      = 'DN';
...
=head1 new
 ...
 Title     : new
 Usage     : my $seqpat = FAST::Bio::Tools::SeqPattern->new();
 Purpose   : Verifies that the type is correct for superclass (FAST::Bio::Seq.pm)
...
See Also   : L<FAST::Bio::Root::Root::new>,
             L<FAST::Bio::Seq::_initialize>
...
#----------------
    ...
    my $t;
    # Get the type ready for FAST::Bio::Seq.pm
    if ($type =~ /nuc|[dr]na/i) {
	$t = 'Dna';
...
=head1 alphabet_ok
 ...
 Purpose   : Checks for invalid regexp characters.
           : Overrides FAST::Bio::Seq::alphabet_ok() to allow
...
=head1 revcom
 ...
 Returns   : Object reference for a new FAST::Bio::Tools::SeqPattern containing
 ...
 Comments  : This method permits the simultaneous searching of both
           ...
           : pattern.
           : Overrides FAST::Bio::Seq::revcom() and calls it first thing.
           : The order of _fixpat() calls is critical.

See Also   : L<FAST::Bio::Seq::revcom>, L</_fixpat_1>, L</_fixpat_2>, L</_fixpat_3>, L</_fixpat_4>, L</_fixpat_5>
...
#    $self->{'_rev'} = $fixrev;
     ...
     return new FAST::Bio::Tools::SeqPattern(-seq =>$fixrev, -type =>$self->type);
}
...
sub backtranslate {
    ...
    $self->_load_module('FAST::Bio::Tools::SeqPattern::Backtranslate');
    FAST::Bio::Tools::SeqPattern::Backtranslate->import("_reverse_translate_motif");
...
An instance of FAST::Bio::Tools::RestrictionEnzyme.pm is a blessed reference
to a hash containing all or some of the following fields:
 ...
 _seq     : (From FAST::Bio::Seq.pm) The original, unexpanded input sequence after untainting.
 _type    : (From FAST::Bio::Seq.pm) 'Dna' or 'Amino'
