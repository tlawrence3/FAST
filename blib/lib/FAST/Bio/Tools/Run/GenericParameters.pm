...
FAST::Bio::Tools::Run framework in bioperl-run distribution.
...
package FAST::Bio::Tools::Run::GenericParameters;
use strict;

use base qw(FAST::Bio::Root::Root FAST::Bio::Tools::Run::ParametersI);
