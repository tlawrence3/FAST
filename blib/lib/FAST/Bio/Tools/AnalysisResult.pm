#
# BioPerl module for FAST::Bio::Tools::AnalysisResult
#
...
=head1 SYNOPSIS
    ...
    # query object, e.g. a FAST::Bio::SeqI implementing object
...
This module also implements the FAST::Bio::SeqAnalysisParserI interface, and
thus can be used wherever such an object fits.  See
L<FAST::Bio::SeqAnalysisParserI>.  Developers will
...
package FAST::Bio::Tools::AnalysisResult;
use strict;

use base qw(FAST::Bio::Root::Root FAST::Bio::SeqAnalysisParserI FAST::Bio::AnalysisResultI FAST::Bio::Root::IO);
...
=head2 analysis_query
 ...
 Purpose   : Set/Get the name of the query used to generate the result, that
             ...
             be a sequence object (FAST::Bio::PrimarySeq compatible).
 Argument  :
 Returns   : The object set before. Mostly a FAST::Bio::PrimarySeq compatible object.
