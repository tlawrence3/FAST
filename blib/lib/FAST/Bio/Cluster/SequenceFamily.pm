#
# BioPerl module for FAST::Bio::Cluster::SequenceFamily
#
...
=head1 SYNOPSIS
  ...
  my $seqio= FAST::Bio::SeqIO->new(-format => 'swiss',
                            -file => $file);
  my @mem;
  ...
  #create the family
  my $family = FAST::Bio::Cluster::SequenceFamily->new(
          -family_id=>"Family_1",
  ...
  #select members if members have a FAST::Bio::Species Object
...
package FAST::Bio::Cluster::SequenceFamily;

use strict;

use base qw(FAST::Bio::Root::Root FAST::Bio::Cluster::FamilyI);


=head2 new

 Title   : new
 Usage   : my $family = FAST::Bio::Cluster::SequenceFamily->new(
                             -family_id=>"Family_1",
                             -description=>"Family Description Here",
                             -annotation_score=>"100",
                             -members=>\@mem);
 Function: Constructor for SequenceFamily object
 Returns : FAST::Bio::Cluster::SequenceFamily object

See L<FAST::Bio::Cluster::SequenceFamily>.
...
=head1 L<FAST::Bio::Cluster::FamilyI> methods
...
=head1 L<FAST::Bio::ClusterI> methods
...
=head2 get_members
 ...
 Function: get members using methods from L<FAST::Bio::Species>
           the phylogenetic tree of the family.
