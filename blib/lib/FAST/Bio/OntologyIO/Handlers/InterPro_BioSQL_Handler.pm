...
package FAST::Bio::OntologyIO::Handlers::InterPro_BioSQL_Handler;
use strict;
...
use FAST::Bio::Ontology::Relationship;
use FAST::Bio::Annotation::DBLink;
use FAST::Bio::Annotation::Reference;

use base qw(FAST::Bio::OntologyIO::Handlers::BaseSAXHandler);
...
sub _initialize {
    ...
    if (!$fact) {
        $fact = FAST::Bio::Ontology::TermFactory->new(-type=>"FAST::Bio::Ontology::Term");
    }
    $self->term_factory($fact);
    my $ontology = FAST::Bio::Ontology::Ontology->new(-name => 'InterPro');
    if (defined($version)) {
        $version = "InterPro version $version";
        $ontology->definition($version);
    }
    $self->_ontology($ontology);
    $is_a_rel = FAST::Bio::Ontology::RelationshipType->get_instance('IS_A');
...
=head2 term_factory
 ...
 Function: Get/set the ontology term factory to use.
           ...
           L<FAST::Bio::Ontology::TermFactory> with the proper -type
           ...
           $ontio->term_factory->type("FAST::Bio::Ontology::MyTerm").

 Example :
 Returns : value of term_factory (a FAST::Bio::Factory::ObjectFactoryI object)
 Args    : on set, new value (a FAST::Bio::Factory::ObjectFactoryI object, optional)
...
=head2 db
 ...
 Function: Sets or retrieves the database adaptor factory.
           ...
           The adaptor factory is a FAST::Bio::DB::DBAdaptorI compliant
           ...
           FAST::Bio::DB::BioDB. You *must* set this property before
           starting the parse.
 ...
 Example :
 Returns : value of db (a FAST::Bio::DB::DBAdaptorI compliant object)
 Args    : on set, new value (a FAST::Bio::DB::DBAdaptorI compliant object
           or undef, optional)
...
=head2 _persist_ontology
 ...
 Args    : the ontology to persist as a FAST::Bio::Ontology::OntologyI
           compliant object
...
sub _persist_ontology{
    ...
    my $ontfact =
        FAST::Bio::Factory::ObjectFactory->new(-type=>"FAST::Bio::Ontology::Ontology");
    # do the lookup:
...
sub start_element {
    ...
    if($tag eq 'interpro'){
        ...
        my $rel = FAST::Bio::Ontology::Relationship->new(
            -subject_term => $term,
        ...
        my $example = FAST::Bio::Annotation::DBLink->new;
        ...
        if($top eq 'example'){
            ...
            my $dblink=FAST::Bio::Annotation::DBLink->new(
                -dbname => $args{id},
        ...
        my $publication = FAST::Bio::Annotation::Reference->new();
