#
# BioPerl module for FAST::Bio::Annotation::Target
#
...
#
# Based on the FAST::Bio::Annotation::DBLink by Ewan Birney
#
...
package FAST::Bio::Annotation::Target;
use strict;

use base qw(FAST::Bio::Annotation::DBLink FAST::Bio::AnnotationI FAST::Bio::Range);
