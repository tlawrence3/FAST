#
# BioPerl module for FAST::Bio::Annotation::OntologyTerm
#
...
package FAST::Bio::Annotation::OntologyTerm;
use strict;
...
use base qw(FAST::Bio::Root::Root FAST::Bio::AnnotationI FAST::Bio::Ontology::TermI);
...
=head1 Methods for FAST::Bio::Ontology::TermI compliance
...
sub term{
    ...
    if(! exists($self->{'term'})) {
        $self->{'term'} = FAST::Bio::Ontology::Term->new();
    }
    return $self->{'term'};
}
