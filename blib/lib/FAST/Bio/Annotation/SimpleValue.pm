#
# BioPerl module for FAST::Bio::Annotation::SimpleValue
#
...
package FAST::Bio::Annotation::SimpleValue;
use strict;

# Object preamble - inherits from FAST::Bio::Root::Root

#use FAST::Bio::Ontology::TermI;

use base qw(FAST::Bio::Root::Root FAST::Bio::AnnotationI);
