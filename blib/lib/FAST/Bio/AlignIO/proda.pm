#
# BioPerl module for FAST::Bio::AlignIO::proda
#
#   based on the FAST::Bio::SeqIO modules
#       by Ewan Birney <birney@ebi.ac.uk>
#       and Lincoln Stein  <lstein@cshl.org>
#       and the FAST::Bio::SimpleAlign module of Ewan Birney
#
...
This object can transform FAST::Bio::Align::AlignI objects to and from proda
files.
...
package FAST::Bio::AlignIO::proda;
...
=head2 new
 ...
 Title   : new
 Usage   : $alignio = FAST::Bio::AlignIO->new(-format => 'proda',
                       -file => 'filename');
 Function: returns a new FAST::Bio::AlignIO object to handle proda files
 Returns : FAST::Bio::AlignIO::proda object
...
See L<FAST::Bio::Align::AlignI> for details
...
sub next_aln {
    ...
    foreach my $name ( sort { $order{$a} <=> $order{$b} } keys %alignments ) {
        ...
        my $seq = FAST::Bio::LocatableSeq->new(
					 -seq      => $alignments{$name},
					 -id       => $sname,
					 -start    => $start,
					 -end      => $end,
