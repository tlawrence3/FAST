#
# BioPerl module for FAST::Bio::AlignIO::selex

#   based on the FAST::Bio::SeqIO::selex module
...
=head1 SYNOPSIS
  ...
  my $in = FAST::Bio::AlignIO->new(-format => 'selex',
...
This object can transform L<FAST::Bio::Align::AlignI> objects to and from selex flat
file databases.
...
package FAST::Bio::AlignIO::selex;
use strict;
...
sub next_aln {
    ...
    my $aln =  FAST::Bio::SimpleAlign->new(-source => 'selex');
