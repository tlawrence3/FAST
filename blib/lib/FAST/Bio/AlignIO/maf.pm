#
# BioPerl module for FAST::Bio::AlignIO::maf
#
# Copyright Allen Day
#
...
This class constructs FAST::Bio::SimpleAlign objects from an MAF-format
...
sub next_aln {
    ...
    my $aln =  FAST::Bio::SimpleAlign->new(-source => 'maf');
	...
	my $seq = FAST::Bio::LocatableSeq->new('-seq'          => $text,
					 '-display_id'   => $src,
					 '-start'        => $start,
					 '-end'          => $start + $size - 1,
					 '-strand'       => $strand,
