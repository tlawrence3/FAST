#
# BioPerl module for FAST::Bio::AlignIO::emboss
#
...
=head1 SYNOPSIS
    ...
    my $in = FAST::Bio::AlignIO->new(-format => 'emboss',
                              -file   => 'seq.water');
...
package FAST::Bio::AlignIO::emboss;
...
sub next_aln {
    ...
    my $aln =  FAST::Bio::SimpleAlign->new(-verbose => $self->verbose(),
				     -score   => $data{'score'},
