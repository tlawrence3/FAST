#
# bioperl module for FAST::Bio::SeqFeature::Tools::TypeMapper
#
...
=head1 SYNOPSIS
  ...
  $tm = FAST::Bio::SeqFeature::Tools::TypeMapper->new;
...
package FAST::Bio::SeqFeature::Tools::TypeMapper;
use strict;
...
=head2 new
 ...
 Title   : new
 Usage   : $unflattener = FAST::Bio::SeqFeature::Tools::TypeMapper->new();
 Function: constructor
 Example : 
 Returns : a new FAST::Bio::SeqFeature::Tools::TypeMapper
 Args    : see below
...
L<FAST::Bio::SeqFeature::Tools::Unflattener> module takes genbank records
