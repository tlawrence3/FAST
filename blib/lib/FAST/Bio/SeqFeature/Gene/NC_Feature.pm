#
# BioPerl module for FAST::Bio::SeqFeature::Gene::NC_Feature.pm
#
...
FAST::Bio::SeqFeature::Gene::NC_Feature.pm - superclass for non-coding features
...
package FAST::Bio::SeqFeature::Gene::NC_Feature;
use strict;
