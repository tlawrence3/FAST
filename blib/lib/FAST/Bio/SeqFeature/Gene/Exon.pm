#
# BioPerl module for FAST::Bio::SeqFeature::Gene::Exon
#
...
the FAST::Bio::SeqFeature::Gene::ExonI interface. By default an Exon is
coding. Supply -is_coding =E<gt> 0 to the constructor or call
$exon-E<gt>is_coding(0) otherwise.

Apart from that, this class also implements FAST::Bio::SeqFeatureI by
inheriting off FAST::Bio::SeqFeature::Generic.
...
package FAST::Bio::SeqFeature::Gene::Exon;
use strict;


use base qw(FAST::Bio::SeqFeature::Generic FAST::Bio::SeqFeature::Gene::ExonI);
...
sub location {
   ...
   if(defined($value) && $value->isa('FAST::Bio::Location::SplitLocationI')) {
