#
# BioPerl module for FAST::Bio::SeqFeature::Gene::UTR
#
...
A UTR is a FAST::Bio::SeqFeature::Gene::ExonI compliant object that is
...
package FAST::Bio::SeqFeature::Gene::UTR;
use strict;

# Object preamble - inherits from FAST::Bio::Root::Root


use base qw(FAST::Bio::SeqFeature::Gene::Exon);
