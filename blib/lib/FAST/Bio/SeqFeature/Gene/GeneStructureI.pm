#
# BioPerl module for FAST::Bio::SeqFeature::Gene::GeneStructureI
#
...
package FAST::Bio::SeqFeature::Gene::GeneStructureI;
use strict;
...
=head2 transcripts
 ...
 Function: Get the transcript features/sites of this gene structure.
           ...
           See FAST::Bio::SeqFeature::Gene::TranscriptI for properties of the
           returned objects.
