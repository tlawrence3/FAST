#
# BioPerl module for FAST::Bio::Seq::RichSeqI
#
...
This interface extends the L<FAST::Bio::SeqI> interface to give additional
...
see the documentation for L<FAST::Bio::Seq::RichSeq>.
...
package FAST::Bio::Seq::RichSeqI;
use strict;

use base qw(FAST::Bio::SeqI);
