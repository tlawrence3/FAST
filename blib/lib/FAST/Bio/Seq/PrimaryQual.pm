#
# bioperl module for FAST::Bio::PrimaryQual
#
...
FAST::Bio::Seq::SeqWithQuality where these quality values
...
package FAST::Bio::Seq::PrimaryQual;
use vars qw(%valid_type);
use strict;


use base qw(FAST::Bio::Root::Root FAST::Bio::Seq::QualI);
...
sub validate_qual {
    ...
    # \d+\s+\d+..., I suppose
    my ($self,$qualstr) = @_;
    # why the CORE?? -- (Because FAST::Bio::PrimarySeqI namespace has a 
