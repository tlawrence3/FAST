#
# BioPerl module for FAST::Bio::Seq::LargePrimarySeq
#
...
package FAST::Bio::Seq::LargePrimarySeq;
use vars qw($AUTOLOAD);
use strict;


use base qw(FAST::Bio::PrimarySeq FAST::Bio::Root::IO FAST::Bio::Seq::LargeSeqI);
...
sub subseq{
   ...
   if( ref($start) && $start->isa('FAST::Bio::LocationI') ) {
       ...
       $loc->strand < 0 ) { 
       $seq = FAST::Bio::PrimarySeq->new(-seq => $seq)->revcom()->seq();
       }
       return $seq;
   }
