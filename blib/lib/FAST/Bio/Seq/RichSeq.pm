#
# BioPerl module for FAST::Bio::Seq::RichSeq
#
...
See L<FAST::Bio::Seq::RichSeqI> and documentation of methods.

=head1 DESCRIPTION

This module implements FAST::Bio::Seq::RichSeqI, an interface for sequences
created from or created for entries from/of rich sequence databanks,
like EMBL, GenBank, and SwissProt. Methods added to the FAST::Bio::SeqI
...
=item L<FAST::Bio::Seq::RichSeqI>

Note that this includes implementing L<FAST::Bio::PrimarySeqI> and L<FAST::Bio::SeqI>,
specifically via L<FAST::Bio::Seq> and L<FAST::Bio::PrimarySeq>. Please review the
documentation for those modules on implementation details relevant to those
interfaces, as well as the ones below.

=item L<FAST::Bio::IdentifiableI>

=item L<FAST::Bio::DescribableI>
...
package FAST::Bio::Seq::RichSeq;
use vars qw($AUTOLOAD);
use strict;



use base qw(FAST::Bio::Seq FAST::Bio::Seq::RichSeqI);
...
sub _add_annotation_value{
	...
	$self->annotation->add_Annotation(
			FAST::Bio::Annotation::SimpleValue->new(-tagname => $key,
							  -value => $val)
					  );
    }
}
