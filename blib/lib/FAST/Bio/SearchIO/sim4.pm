#
# BioPerl module for FAST::Bio::SearchIO::sim4
#
...
package FAST::Bio::SearchIO::sim4;
...
sub next_result {
	...
	next if( /^\s+$/); chomp;
	    ...
	    if ( /^\#:lav/ ) { $format = 2; }
            ...
            $self->throw("FAST::Bio::SearchIO::sim4 module cannot parse 'type $format' outputs.") if $format;
	}
