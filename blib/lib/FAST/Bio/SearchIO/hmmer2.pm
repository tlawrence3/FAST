#
# BioPerl module for FAST::Bio::SearchIO::hmmer2
#
...
=head1 SYNOPSIS
    ...
    my $in = FAST::Bio::SearchIO->new(-format => 'hmmer2',
...
package FAST::Bio::SearchIO::hmmer2;
...
use base qw(FAST::Bio::SearchIO::hmmer);
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = FAST::Bio::SearchIO::hmmer2->new();
 Function: Builds a new FAST::Bio::SearchIO::hmmer2 object
 Returns : FAST::Bio::SearchIO::hmmer2
