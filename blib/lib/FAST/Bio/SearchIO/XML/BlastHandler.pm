#
# BioPerl module for FAST::Bio::SearchIO::XML::BlastHandler
#
...
to the event handler, which is ultimately responsible for FAST::Bio::Search object
generation.

This was recently split off from the original code for FAST::Bio::SearchIO::blastxml
...
# Let the code begin...
package FAST::Bio::SearchIO::XML::BlastHandler;
use base qw(FAST::Bio::Root::Root XML::SAX::Base);
...
=head2 end_element
 ...
 Returns : FAST::Bio::Search object dpending on what type of element
 Args    : hash ref for data
