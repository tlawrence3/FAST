#
# BioPerl module for FAST::Bio::SearchIO::Writer::HTMLResultWriter
#
...
a set of HTML for a specific L<FAST::Bio::Search::Report::ReportI> interface.
...
package FAST::Bio::SearchIO::Writer::HTMLResultWriter;
use strict;
...
sub default_start_report {
    ...
    return sprintf(
    qq{<HTML>
      <HEAD> <CENTER><TITLE>Bioperl Reformatted HTML of %s output with Bioperl FAST::Bio::SearchIO system</TITLE></CENTER></HEAD>
      <!------------------------------------------------------------------->
      <!-- Generated by FAST::Bio::SearchIO::Writer::HTMLResultWriter          -->
      <!-- %s -->
      <!-- http://bioperl.org                                            -->
      <!------------------------------------------------------------------->
      <BODY BGCOLOR="WHITE">
