#
# BioPerl module for FAST::Bio::SearchIO::Writer::BSMLResultWriter
#
...
=head1 SYNOPSIS
  ...
  my $in = FAST::Bio::SearchIO->new(-file   => 'result.blast',
                             -format => 'blast');
  my $out = FAST::Bio::SearchIO->new(-output_format  => 'BSMLResultWriter',
                              -file           => ">result.bsml");
...
package FAST::Bio::SearchIO::Writer::BSMLResultWriter;
use strict;
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = FAST::Bio::SearchIO::Writer::BSMLResultWriter->new();
 Function: Builds a new FAST::Bio::SearchIO::Writer::BSMLResultWriter object 
 Returns : an instance of FAST::Bio::SearchIO::Writer::BSMLResultWriter
 Args    :
