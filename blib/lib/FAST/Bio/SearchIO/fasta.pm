#
# BioPerl module for FAST::Bio::SearchIO::fasta
#
...
=head1 SYNOPSIS
  ...
  # Do not use this object directly, use it through the SearchIO system
   ...
   my $searchio = FAST::Bio::SearchIO->new(-format => 'fasta',
                    -file   => 'report.FASTA');
   while( my $result = $searchio->next_result ) {
    # ... do what you would normally doi with FAST::Bio::SearchIO.
   }

=head1 DESCRIPTION

This object contains the event based parsing code for FASTA format
reports.  It creates L<FAST::Bio::Search::HSP::FastaHSP> objects instead of
L<FAST::Bio::Search::HSP::GenericHSP> for the HSP objects. 
...
package FAST::Bio::SearchIO::fasta;
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = FAST::Bio::SearchIO::fasta->new();
 Function: Builds a new FAST::Bio::SearchIO::fasta object 
 Returns : FAST::Bio::SearchIO::fasta
...
sub _initialize {
    ...
    $self->_eventHandler->register_factory(
        ...
        FAST::Bio::Factory::ObjectFactory->new(
            -type      => 'FAST::Bio::Search::HSP::FastaHSP',
            -interface => 'FAST::Bio::Search::HSP::HSPI'
        )
    );
    return 1;
}
