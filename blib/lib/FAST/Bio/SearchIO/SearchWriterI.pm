#-----------------------------------------------------------------
#
# BioPerl module FAST::Bio::SearchIO::SearchWriterI
#
...
FAST::Bio::SearchIO::SearchWriterI objects cannot be instantiated since this
module defines a pure interface.

Given an object that implements the FAST::Bio::SearchIO::SearchWriterI interface,
...
to be used for outputting results from L<FAST::Bio::Search::Result::ResultI>
objects.
...
package FAST::Bio::SearchIO::SearchWriterI;
