#
# BioPerl module for FAST::Bio::SearchIO::FastHitEventBuilder
#
...
and build appropriate FAST::Bio::Search::* objects from them.  This object
...
package FAST::Bio::SearchIO::FastHitEventBuilder;
