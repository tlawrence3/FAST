#
# BioPerl module for FAST::Bio::SearchIO::blasttable
#
...
=head1 SYNOPSIS
  ...
  my $parser = FAST::Bio::SearchIO->new(-file   => $file,
                                 -format => 'blasttable');
...
package FAST::Bio::SearchIO::blasttable;
use vars qw(%MAPPING %MODEMAP $DEFAULT_WRITER_CLASS $DefaultProgramName);
use strict;
use FAST::Bio::Search::Result::ResultFactory;
use FAST::Bio::Search::Hit::HitFactory;
use FAST::Bio::Search::HSP::HSPFactory;

$DefaultProgramName = 'BLASTN';
$DEFAULT_WRITER_CLASS = 'FAST::Bio::SearchIO::Writer::HitTableWriter';
...
use base qw(FAST::Bio::SearchIO);

=head2 new

 Title   : new
 Usage   : my $obj = FAST::Bio::SearchIO::blasttable->new();
 Function: Builds a new FAST::Bio::SearchIO::blasttable object 
 Returns : an instance of FAST::Bio::SearchIO::blasttable
 Args    :
...
sub _initialize {
    ...
    $self->_eventHandler->register_factory('result', FAST::Bio::Search::Result::ResultFactory->new(-type => 'FAST::Bio::Search::Result::GenericResult'));
    $self->_eventHandler->register_factory('hit', FAST::Bio::Search::Hit::HitFactory->new(-type => 'FAST::Bio::Search::Hit::GenericHit'));
    $self->_eventHandler->register_factory('hsp', FAST::Bio::Search::HSP::HSPFactory->new(-type => 'FAST::Bio::Search::HSP::GenericHSP'));
}
...
=head2 next_result
 ...
 Returns : L<FAST::Bio::Search::Result::ResultI>
 Args    : none
