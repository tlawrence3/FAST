#
# BioPerl module for FAST::Bio::Location::Fuzzy
...
package FAST::Bio::Location::Fuzzy;
use strict;

use base qw(FAST::Bio::Location::Atomic FAST::Bio::Location::FuzzyLocationI);
    ...
    if( defined $value || ! defined $self->{'_location_type'} ) {
        ...
        if(! defined $FUZZYCODES{$value} )  {
            ...
            if( $value =~ /\.\./ ) {
                ...
                $value = 'IN-BETWEEN';
                $self->throw("Use FAST::Bio::Location::Simple for IN-BETWEEN locations [".
...
See L<FAST::Bio::Location::CoordinatePolicyI>
