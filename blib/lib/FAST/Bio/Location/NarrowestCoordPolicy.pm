#
# BioPerl module for FAST::Bio::Location::NarrowestCoordPolicy
#
...
CoordinatePolicyI implementing objects are used by FAST::Bio::LocationI
...
package FAST::Bio::Location::NarrowestCoordPolicy;
use strict;


use base qw(FAST::Bio::Root::Root FAST::Bio::Location::CoordinatePolicyI);
...
=head2 start
  ...
  Args    : A FAST::Bio::LocationI implementing object.
...
sub start {
    ...
    # For performance reasons we don't check that it's indeed a FAST::Bio::LocationI
