...
use parent qw(FAST::Bio::Root::Root FAST::Bio::Root::IO FAST::Bio::Factory::SequenceStreamI);
...
=head2 new
 ...
 Title   : new
 Usage   : $stream = FAST::Bio::SeqIO->new(-file => 'sequences.fasta',
                                     -format => 'fasta');
...
# format() method inherited from FAST::Bio::Root::IO
