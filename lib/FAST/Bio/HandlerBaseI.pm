#
# BioPerl module for FAST::Bio::HandlerI
#
...
file (such as when using a "pull" parser, like a FAST::Bio::PullParserI).

For an sequence-based implementation see
FAST::Bio::SeqIO::RichSeq::GenericRichSeqHandler, which handles any GenBank,
UniProt, and EMBL data from their respective driver modules
(FAST::Bio::SeqIO::gbdriver, FAST::Bio::SeqIO::swissdriver, and
FAST::Bio::SeqIO::embldriver).
