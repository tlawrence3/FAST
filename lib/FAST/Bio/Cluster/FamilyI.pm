#
# BioPerl module for FAST::Bio::Cluster::FamilyI
#
...
found a L<FAST::Bio::Cluster::Family>.
...
package FAST::Bio::Cluster::FamilyI;
use strict;


use base qw(FAST::Bio::ClusterI);
...
=head1 Methods inherited from L<FAST::Bio::ClusterI>
