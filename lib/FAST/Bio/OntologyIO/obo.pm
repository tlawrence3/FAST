#
# BioPerl module for FAST::Bio::OntologyIO::obo
#
...
package  FAST::Bio::OntologyIO::obo;
...
sub parse {
    ...
    $self->term_factory(
        FAST::Bio::Ontology::TermFactory->new( -type => "FAST::Bio::Ontology::OBOterm" ) )
    ...
    my $ont = FAST::Bio::Ontology::Ontology->new(
...
##################################
    ...
    while ( my $term = $self->_next_term() ) {
        ...
        if ( $new_ontology_flag && $term->namespace() ) {
            my $new_ont = FAST::Bio::Ontology::Ontology->new(
                -name   => $term->namespace(),
                -engine => $self->_ont_engine()
            );
...
=head2 next_ontology
 ...
 Example :
 Returns : An object implementing FAST::Bio::Ontology::OntologyI, and nothing if
...
sub _add_ontology {
    ...
    foreach my $ont (@_) {
        $self->throw(
            ref($ont) . " does not implement FAST::Bio::Ontology::OntologyI" )
...
sub _header {
    my $self                  = shift;
    my $annotation_collection = FAST::Bio::Annotation::Collection->new();
    my ( $tag, $value );
    my $line_counter = 0;
...
/^(\[|format-version:|typeref:|version:|date:|saved-by:|auto-generated-by:|default-namespace:|remark:|subsetdef:)/
          )
        {
            ...
            my $header = FAST::Bio::Annotation::SimpleValue->new( -value => $value );
...
# Creates a FAST::Bio::Ontology::OBOterm object
