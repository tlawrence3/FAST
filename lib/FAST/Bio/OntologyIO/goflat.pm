#
# BioPerl module for FAST::Bio::OntologyIO::goflat
#
...
package  FAST::Bio::OntologyIO::goflat;
...
use base qw(FAST::Bio::OntologyIO::dagflat);
...
=head2 new
 ...
 Returns : A new goflat parser object, implementing FAST::Bio::OntologyIO.
