#
# BioPerl module for FAST::Bio::OntologyIO::simplehierarchy
#
...
OntologyIO::dagflat, see L<FAST::Bio::OntologyIO::dagflat> for details.
...
package  FAST::Bio::OntologyIO::simplehierarchy;
...
=head2 new
 ...
 Returns : A new simplehierarchy parser object, implementing FAST::Bio::OntologyIO.
 Args    : -files         => a single ontology flat file holding the
           ...
           -file_is_root  => Boolean indicating whether a virtual root
                             ...
                             separately rooted.
           -engine        => the L<FAST::Bio::Ontology::OntologyEngineI> object
                             to be reused (will be created otherwise); note
                             that every L<FAST::Bio::Ontology::OntologyI> will
