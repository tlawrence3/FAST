#
# BioPerl module for FAST::Bio::SeqIO::FTHelper
#
...
Used by FAST::Bio::SeqIO::EMBL,FAST::Bio::SeqIO::genbank, and FAST::Bio::SeqIO::swiss to
...
package FAST::Bio::SeqIO::FTHelper;
use strict;
...
=head2 _generic_seqfeature
 ...
 Args    : The FAST::Bio::Factory::LocationFactoryI object to use for parsing
...
sub _generic_seqfeature {
    ...
    $sf = FAST::Bio::SeqFeature::Generic->direct_new();
...
=head2 from_SeqFeature
 ...
 Usage   : @fthelperlist = FAST::Bio::SeqIO::FTHelper::from_SeqFeature($sf,
						     $context_annseq);
...
sub from_SeqFeature {
  ...
  my $fth = FAST::Bio::SeqIO::FTHelper->new();
  ...
  #my @subfth = &FAST::Bio::SeqIO::FTHelper::from_SeqFeature($sub);
  #push(@ret, @subfth);
  #}
  ...
  foreach my $ft (@ret) {
	if ( !$ft->isa('FAST::Bio::SeqIO::FTHelper') ) {
