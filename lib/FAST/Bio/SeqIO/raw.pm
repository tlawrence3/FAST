...
#
# This code is based on his FAST::Bio::SeqIO::Fasta module with
...
This object can transform FAST::Bio::Seq objects to and from raw flat
file databases.
...
sub write_seq {
    my ($self,@seq) = @_;
    foreach my $seq (@seq) {
        $self->throw("Must provide a valid FAST::Bio::PrimarySeqI object")
...
sub write_qual {
    ...
    my @qual = ();
    foreach (@seq) {
        unless ($_->isa("FAST::Bio::Seq::Quality")){
           warn("You cannot write raw qualities without supplying a FAST::Bio::Seq::".
