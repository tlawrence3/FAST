# BioPerl module for FAST::Bio::SeqIO::metafasta
#
...
This object can transform FAST::Bio::Seq::Meta objects to and from metafasta
flat file databases.

For sequence part the code is an exact copy of FAST::Bio::SeqIO::fasta
...
package FAST::Bio::SeqIO::metafasta;
use vars qw($WIDTH);
use strict;
