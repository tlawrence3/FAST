#
# BioPerl module for FAST::Bio::SeqIO::swissdriver
#
...
This object can transform FAST::Bio::Seq objects to and from UniProt flat file
databases. The key difference between this parser and the tried-and-true
FAST::Bio::SeqIO::swiss parser is this version separates the parsing and data
...
package FAST::Bio::SeqIO::swissdriver;
use vars qw(%FTQUAL_NO_QUOTE);
use strict;
use FAST::Bio::SeqIO::Handler::GenericRichSeqHandler;
use Data::Dumper;
...
sub write_seq {
    shift->throw("Use FAST::Bio::SeqIO::swiss write_seq() for output");
