# $Id: 
#
# BioPerl module for FAST::Bio::SeqIO::game::gameHandler
#
...
FAST::Bio::SeqIO::game::gameHandler is the top-level XML handler invoked by PerlSAX
...
package FAST::Bio::SeqIO::game::gameHandler;

use FAST::Bio::SeqIO::game::seqHandler;
use strict;
use vars qw {};
...
sub load {
	...
	my $bio = FAST::Bio::SeqIO::game::seqHandler->new( $seq, $ann, $comp, $map, $src );
