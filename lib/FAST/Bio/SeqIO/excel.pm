#
# BioPerl module for FAST::Bio::SeqIO::excel
#
...
=head1 SYNOPSIS
  ...
  $stream = FAST::Bio::SeqIO->new(-file => $filename, -format => 'excel');
...
FAST::Bio::Seq objects. It is derived from the table format module and
...
L<FAST::Bio::SeqIO::table> for a complete list of parameters and
capabilities.
...
use base qw(FAST::Bio::SeqIO::table);

=head2 new

 Title   : new
 Usage   : $stream = FAST::Bio::SeqIO->new(-file => $filename, -format => 'excel')
 Function: Returns a new seqstream
 Returns : A FAST::Bio::SeqIO stream for a MS Excel format

 Args    : Supports the same named parameters as FAST::Bio::SeqIO::table,
