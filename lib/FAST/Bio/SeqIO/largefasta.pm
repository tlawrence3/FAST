# BioPerl module for FAST::Bio::SeqIO::largefasta
#
...
FAST::Bio::Seq::LargePrimarySeq module to store all the sequence data in
...
FAST::Bio::Seq::LargePrimarySeq object.  The default location for this is
...
L<FAST::Bio::Seq::LargePrimarySeq> for more information.

    $FAST::Bio::Seq::LargePrimarySeq::DEFAULT_TEMP_DIR = 'newdir';
...
package FAST::Bio::SeqIO::largefasta;
  ...
  if( ! defined $self->sequence_factory ) {
      $self->sequence_factory(FAST::Bio::Seq::SeqFactory->new
			      (-verbose => $self->verbose(), 
			       -type => 'FAST::Bio::Seq::LargePrimarySeq'));      
  }
}
...
=head2 next_seq
 ...
 Returns : A FAST::Bio::Seq::LargePrimarySeq object
 Args    : NONE
