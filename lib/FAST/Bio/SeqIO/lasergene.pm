#-----------------------------------------5~------------------------------------
# PACKAGE : FAST::Bio::SeqIO::lasergene
# AUTHOR  : Malcolm Cook <mec@stowers-institute.org>
# CREATED : Feb 16 1999
#
# _History_
#
# This code is based on the FAST::Bio::SeqIO::raw module with
...
This object can product FAST::Bio::Seq::RichSeq objects from Lasergene sequence files.
...
#   print STDERR "SEQ=[[$sequence]]\n";
   ...
   my $seq = FAST::Bio::Seq->new(-seq => $sequence);

   my $comment = join('; ', @comment);
#   print STDERR "COM=[[$comment]]\n";
   my $anno = FAST::Bio::Annotation::Collection->new;
   $anno->add_Annotation('comment', FAST::Bio::Annotation::Comment->new(-text => $comment) );
   $seq->annotation($anno);
