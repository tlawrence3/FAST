#
# BioPerl module for FAST::Bio::SeqIO::gbdriver
#
...
This object can transform FAST::Bio::Seq objects to and from GenBank flat file
databases. The key difference between this parser and the tried-and-true
FAST::Bio::SeqIO::genbank parser is this version separates the parsing and data
...
package FAST::Bio::SeqIO::gbdriver;
use strict;
use warnings;
use Data::Dumper;
...
sub write_seq {
    shift->throw("Use FAST::Bio::SeqIO::genbank for output");
