# BioPerl module for FAST::Bio::Seq::TraceI
#
...
=head1 SYNOPSIS
    ...
    # to test this is a seq object
          $st->isa("FAST::Bio::Seq::TraceI") 
               || $obj->throw("$obj does not implement the FAST::Bio::Seq::TraceI interface");
     ...
     $arrayref = $st->false_trace("A",FAST::Bio::Seq::Quality, $accuracy);
...
package FAST::Bio::Seq::TraceI;
use strict;
use Carp;
use Dumpvalue;
use FAST::Bio::Root::RootI;
...
sub trace {
   my ($self) = @_;
   if( $self->can('throw') ) {
       $self->throw("FAST::Bio::Seq::TraceI definition of trace - implementing class did not provide this method");
   } else {
       confess("FAST::Bio::Seq::TraceI definition of trace - implementing class did not provide this method");
   }
}
...
sub subtrace {
   ...
   if( $self->can('throw') ) {
       $self->throw("FAST::Bio::Seq::TraceI definition of subtrace - implementing class did not provide this method");
   } else {
       confess("FAST::Bio::Seq::TraceI definition of subtrace - implementing class did not provide this method");
   }
...
sub traceat {
   my ($self,$value) = @_;
   if( $self->can('warn') ) {
       $self->warn("FAST::Bio::Seq::TraceI definition of traceat - implementing class did not provide this method");
   } else {
       warn("FAST::Bio::Seq::TraceI definition of traceat - implementing class did not provide this method");
   }
   return '';
} 
...
sub length {
   my ($self)= @_;
   if( $self->can('throw') ) {
       $self->throw("FAST::Bio::Seq::TraceI definition of length - implementing class did not provide this method");
   } else {
       confess("FAST::Bio::Seq::TraceI definition of length - implementing class did not provide this method");
   }
}
...
sub trace_indices {
   my ($self)= @_;
   if( $self->can('throw') ) {
       $self->throw("FAST::Bio::Seq::TraceI definition of trace_indices - implementing class did not provide this method");
   } else {
       confess("FAST::Bio::Seq::TraceI definition of trace_indices - implementing class did not provide this method");
   }
}
