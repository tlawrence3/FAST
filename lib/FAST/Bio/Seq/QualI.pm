#
# BioPerl module for FAST::Bio::Seq::QualI
#
...
FAST::Bio::Seq::PrimaryQual. If you just want to use FAST::Bio::Seq::PrimaryQual
...
this. (An implementation is provided in FAST::Bio::Seq::PrimaryQual). If you
want to provide a FAST::Bio::Seq::PrimaryQual 'compliant' object which in
...
which would inherit from your object and this FAST::Bio::Seq::QualI
...
This module is heavily based on FAST::Bio::Seq::PrimarySeq and is modeled after
...
sub qual {
   my ($self) = @_;
   if( $self->can('throw') ) {
       $self->throw("FAST::Bio::Seq::QualI definition of qual - implementing class did not provide this method");
   } else {
       confess("FAST::Bio::Seq::QualI definition of qual - implementing class did not provide this method");
   }
}
...
sub subqual {
   ...
   if( $self->can('throw') ) {
       $self->throw("FAST::Bio::Seq::QualI definition of subqual - implementing class did not provide this method");
   } else {
       confess("FAST::Bio::Seq::QualI definition of subqual - implementing class did not provide this method");
   }
...
sub display_id {
   ...
   if( $self->can('throw') ) {
       $self->throw("FAST::Bio::Seq::QualI definition of id - implementing class did not provide this method");
   } else {
       confess("FAST::Bio::Seq::QualI definition of id - implementing class did not provide this method");
   }
...
sub accession_number {
   ...
   if( $self->can('throw') ) {
       $self->throw("FAST::Bio::Seq::QualI definition of seq - implementing class did not provide this method");
   } else {
       confess("FAST::Bio::Seq::QualI definition of seq - implementing class did not provide this method");
   }
...
sub qualat {
   my ($self,$value) = @_;
   if( $self->can('warn') ) {
       $self->warn("FAST::Bio::Seq::QualI definition of qualat - implementing class did not provide this method");
   } else {
       warn("FAST::Bio::Seq::QualI definition of qualat - implementing class did not provide this method");
   }
   return '';
} 
...
the latter case a FAST::Bio::PrimarySeq object will be created. Implementors
...
sub revcom{
   ...
   if($self->can_call_new()) {
       ...
       $seqclass = 'FAST::Bio::Seq::PrimaryQual';
		# Wassat?
...
sub length {
   my ($self)= @_;
   if( $self->can('throw') ) {
       $self->throw("FAST::Bio::Seq::QualI definition of length - implementing class did not provide this method");
   } else {
       confess("FAST::Bio::Seq::QualI definition of length - implementing class did not provide this method");
   }
}
...
sub desc {
   my ($self,$value) = @_;
   if( $self->can('warn') ) {
       $self->warn("FAST::Bio::Seq::QualI definition of desc - implementing class did not provide this method");
   } else {
       warn("FAST::Bio::Seq::QualI definition of desc - implementing class did not provide this method");
   }
   return '';
}
...
sub _attempt_to_load_Seq{
   ...
   if( $main::{'FAST::Bio::Seq::PrimaryQual'} ) {
       return 1;
   } else {
       eval {
	   require FAST::Bio::Seq::PrimaryQual;
       };
       if( $@ ) {
	   if( $self->can('throw') ) {
	       $self->throw("FAST::Bio::Seq::PrimaryQual could not be loaded for $self\nThis indicates that you are using FAST::Bio::Seq::PrimaryQualI without FAST::Bio::Seq::PrimaryQual loaded and without providing a complete solution\nThe most likely problem is that there has been a misconfiguration of the bioperl environment\nActual exception\n\n$@\n");
	   } else {
	       confess("FAST::Bio::Seq::PrimarySeq could not be loaded for $self\nThis indicates that you are usnig FAST::Bio::Seq::PrimaryQualI without FAST::Bio::Seq::PrimaryQual loaded and without providing a complete solution\nThe most likely problem is that there has been a misconfiguration of the bioperl environment\nActual exception\n\n$@\n");
	   }
	   return 0;
       }
       return 1;
