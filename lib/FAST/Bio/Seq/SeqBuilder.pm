#
# BioPerl module for FAST::Bio::Seq::SeqBuilder
#
...
=head1 SYNOPSIS
   ...
   my $seqin = FAST::Bio::SeqIO->new(-fh => \*STDIN, -format => "genbank");
...
This is an implementation of L<FAST::Bio::Factory::ObjectBuilderI> used by
...
package FAST::Bio::Seq::SeqBuilder;
use strict;

# Object preamble - inherits from FAST::Bio::Root::Root


use base qw(FAST::Bio::Root::Root FAST::Bio::Factory::ObjectBuilderI);
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = FAST::Bio::Seq::SeqBuilder->new();
 Function: Builds a new FAST::Bio::Seq::SeqBuilder object 
 Returns : an instance of FAST::Bio::Seq::SeqBuilder
 Args    :
...
=head1 Methods for implementing L<FAST::Bio::Factory::ObjectBuilderI>
...
=head2 sequence_factory
 ...
 Function: Get/set the sequence factory to be used by this object
           builder.
 Example : 
 Returns : the FAST::Bio::Factory::SequenceFactoryI implementing object to use
 Args    : on set, new value (a FAST::Bio::Factory::SequenceFactoryI
