#
# BioPerl module for FAST::Bio::Seq::MetaI
#
...
=head1 SYNOPSIS
  ...
  # get a FAST::Bio::Seq::MetaI compliant object somehow

  # to test this is a meta seq object
  $obj->isa("FAST::Bio::Seq::MetaI")
     || $obj->throw("$obj not a FAST::Bio::Seq::MetaI");
...
FAST::Bio::Seq::Meta provides basic, pure perl implementation of sequences
with meta information. See L<FAST::Bio::Seq::Meta>. Application specific
...
L<FAST::Bio::Seq::EncodedSeq>, 
L<FAST::Bio::Tools::OddCodes>, 
...
Implemeting classes will need to rewrite these FAST::Bio::PrimaryI methods.
...
=head2 revcom
 ...
 Returns : A new (fresh) FAST::Bio::Seq::MetaI object
 Args    : none
...
=head2 trunc
 ...
 Returns : a fresh FAST::Bio::Seq::MetaI implementing object
