#
# BioPerl module for FAST::Bio::SeqFeature::Gene::TranscriptI
#
...
package FAST::Bio::SeqFeature::Gene::TranscriptI;
use strict;

use Carp;

use base qw(FAST::Bio::SeqFeatureI);
...
=head2 exons
 ...
 Function: Get the individual exons this transcript comprises of, or all exons
           ...
           See FAST::Bio::SeqFeature::Gene::ExonI for properties of the
           returned objects.
...
=head2 poly_A_site
 ...
 Returns : A FAST::Bio::SeqFeatureI implementing object.
 Args    : 
...
=head2 parent
 ...
 Returns : value of parent - a FAST::Bio::SeqFeature::Gene::GeneStructureI-compliant object
 Args    : a FAST::Bio::SeqFeature::Gene::GeneStructureI-compliant object (optional)
...
sub parent{
   ...
   if( @_ ) {
       ...
       if (! defined $value || 
	   $value->isa("FAST::Bio::SeqFeature::Gene::GeneStructureI")) {
	   $self->{'_parent'} = $value;
       } else {
	   $self->throw("$value must be a FAST::Bio::SeqFeature::Gene::GeneStructureI")
       }
    }
    return $self->{'_parent'};
}
