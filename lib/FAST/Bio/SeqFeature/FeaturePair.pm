#
# BioPerl module for FAST::Bio::SeqFeature::FeaturePair
#
...
=head1 SYNOPSIS
    ...
    my $feat  = FAST::Bio::SeqFeature::FeaturePair->new(-feature1 => $f1,
						 -feature2 => $f2,
					      );

    # FAST::Bio::SeqFeatureI methods can be used

    my $start = $feat->start;
    my $end   = $feat->end;

    # FAST::Bio::FeaturePair methods can be used
...
feature $f2.  A FeaturePair object can then be made
    ...
    my $fp = FAST::Bio::SeqFeature::FeaturePair->new(-feature1 => $f1,   # genomic
					      -feature2 => $f2,   # protein
					      );

This object can be used as a standard FAST::Bio::SeqFeatureI in which case

    my $gstart = $fp->start  # returns start coord on feature1 - genomic seq.
    my $gend   = $fp->end    # returns end coord on feature1.

In general standard FAST::Bio::SeqFeatureI method calls return information
in feature1.
...
package FAST::Bio::SeqFeature::FeaturePair;
use vars qw($AUTOLOAD);
use strict;

use FAST::Bio::SeqFeatureI;
use FAST::Bio::Factory::ObjectFactory;

use base qw(FAST::Bio::SeqFeature::Generic);
...
=head2 new
 ...
 Function: Constructor for this module. Accepts the following parameters:
             ...
             -feature1   FAST::Bio::SeqFeatureI-compliant object
             -feature2   FAST::Bio::SeqFeatureI-compliant object
             -feature_factory  FAST::Bio::Factory::ObjectFactoryI compliant
...
sub new {
    ...
    if(! $featfact) {
	$featfact = FAST::Bio::Factory::ObjectFactory->new(
				   -type => "FAST::Bio::SeqFeature::Generic",
				   -interface => "FAST::Bio::SeqFeatureI");
    }
...
=head2 feature1
 ...
 Returns : FAST::Bio::SeqFeatureI
 Args    : FAST::Bio::SeqFeatureI
...
sub feature1 {
	...
	$self->throw("Argument [$arg] must be a FAST::Bio::SeqFeatureI") 
	    unless (ref($arg) && $arg->isa("FAST::Bio::SeqFeatureI"));
	$self->{'feature1'} = $arg;
    }
...
=head2 feature_factory
 ...
 Function: Get/set the feature object factory for this feature pair.
           ...
           The default is an instance of FAST::Bio::Factory::ObjectFactory
           and hence allows the type to be changed dynamically at any
           time.

 Example : 
 Returns : The feature object factory in use (a 
           FAST::Bio::Factory::ObjectFactoryI compliant object)
