#
# BioPerl module for FAST::Bio::SeqFeature::SimilarityPair
#
...
features. This class inherits off FAST::Bio::SeqFeature::FeaturePair and
therefore implements FAST::Bio::SeqFeatureI, whereas the two features of the
pair are descendants of FAST::Bio::SeqFeature::Generic, with better support
...
package FAST::Bio::SeqFeature::SimilarityPair;
use strict;

use FAST::Bio::SeqFeature::Similarity;
use FAST::Bio::Factory::ObjectFactory;

use base qw(FAST::Bio::SeqFeature::FeaturePair);
...
sub new {
	...
	my $fact = FAST::Bio::Factory::ObjectFactory->new(
                                    -type => "FAST::Bio::SeqFeature::Similarity",
...
See L<FAST::Bio::SeqFeature::Similarity>, L<FAST::Bio::SeqFeature::FeaturePair>
