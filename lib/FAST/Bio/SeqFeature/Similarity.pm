#
# BioPerl module for FAST::Bio::SeqFeature::Similarity
#
...
Everything else is inherited from L<FAST::Bio::SeqFeature::Generic>.
...
package FAST::Bio::SeqFeature::Similarity;
use strict;
...
sub seqdesc {
    ...
    if( defined $value ) { 
	my $v = FAST::Bio::Annotation::SimpleValue->new();
	$v->value($value);
