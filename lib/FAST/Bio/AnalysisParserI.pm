#---------------------------------------------------------------
#
# BioPerl module FAST::Bio::AnalysisParserI
#
# Please direct questions and support issues to <bioperl-l@bioperl.org> 
#
# Cared for by Steve Chervitz <sac@bioperl.org>
#
# Derived from FAST::Bio::SeqAnalysisParserI by Jason Stajich, Hilmar Lapp.
#
...
This module was derived from FAST::Bio::SeqAnalysisParserI, the differences being
...
(FAST::Bio::AnalysisResultI objects). Each AnalysisResultI can then be
queried for its features (if any) as well as other information
about the result

=item 2. AnalysisParserI is a pure interface.

It does not inherit from FAST::Bio::Root::RootI and does not provide a new()
method. Implementations are free to choose how to implement it.

=back

=head2 Rationale (copied from FAST::Bio::SeqAnalysisParserI)
...
Create FAST::Bio::Factory::AnalysisParserFactoryI and
FAST::Bio::Factory::AnalysisParserFactory for interface and an implementation.
Note that this factory could return FAST::Bio::SearchIO-derived objects.
...
Authors of FAST::Bio::SeqAnalysisParserI on which this module is based:
...
package FAST::Bio::AnalysisParserI;
use strict;
...
=head2 next_result
 ...
 Example :
 Returns : A FAST::Bio::Search::Result::ResultI implementing object, 
