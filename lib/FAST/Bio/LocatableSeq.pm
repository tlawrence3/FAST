#
# BioPerl module for FAST::Bio::LocatableSeq
#
...
=head1 SYNOPSIS
    ...
    my $seq = FAST::Bio::LocatableSeq->new(-seq => "CAGT-GGT",
                    -id  => "seq1",
                    -start => 1,
                    -end   => 7);
...
thought. Also, the sequence is not a FAST::Bio::SeqI, so the location is simply
inherited from FAST::Bio::RangeI and is not stored in a FAST::Bio::Location. 
...
use base qw(FAST::Bio::PrimarySeq FAST::Bio::RangeI);
...
=head2 mapping
 ...
 Args    : two elements (# symbols => # coordinate pos); this can also be
           ...
           passed upon FAST::Bio::LocatableSeq instantiation, for instance).
...
=head2 location_from_column
 ...
 Function:
           ...
           L<FAST::Bio::Location::Simple> where values can be undefined. 
         ...
         Seq/91-96 .AC..DEF.G.
           ...
           An exact position returns a FAST::Bio::Location::Simple object
 ...
 Returns : FAST::Bio::Location::Simple or undef
 Args    : A column number
 Throws  : If column is not within the sequence

See L<FAST::Bio::Location::Simple> for more.
...
sub location_from_column {
    ...
    $loc = FAST::Bio::Location::Simple->new
        (-start  => $relative_pos,
         -end    => $relative_pos,
         -strand => 1,
         );
...
=head2 revcom
 ...
 Function: Produces a new FAST::Bio::LocatableSeq object which
 ...
 Returns : A new FAST::Bio::LocatableSeq object
 Args    : none
