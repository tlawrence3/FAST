#
# BioPerl module for FAST::Bio::Annotation::Reference
#
...
=head1 SYNOPSIS
    ...
    $reg = FAST::Bio::Annotation::Reference->new( -title    => 'title line',
...
package FAST::Bio::Annotation::Reference;
use strict;

use base qw(FAST::Bio::Annotation::DBLink);

=head2 new

 Title   : new
 Usage   : $ref = FAST::Bio::Annotation::Reference->new( -title => 'title line',
                           -authors => 'author line',
                           -location => 'location line',
                           -medline => 9988812);
 Function:
