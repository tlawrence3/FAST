#
# BioPerl module for FAST::Bio::Annotation::DBLink
#
...
Aside from L<FAST::Bio::AnnotationI>, this class also implements
L<FAST::Bio::IdentifiableI>.
...
package FAST::Bio::Annotation::DBLink;
use strict;

use base qw(FAST::Bio::Root::Root FAST::Bio::AnnotationI FAST::Bio::IdentifiableI);
...
sub new {
  ...
  $type        && $self->type($type);
  # FAST::Bio::IdentifiableI parameters:
