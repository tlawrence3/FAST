#
# BioPerl module for FAST::Bio::Annotation::AnnotationFactory
#
...
=head1 SYNOPSIS
    ...
    use FAST::Bio::Annotation::AnnotationFactory;
    # 
    my $factory = FAST::Bio::Annotation::AnnotationFactory->new(
                    -type => 'FAST::Bio::Annotation::SimpleValue');
...
This object will build L<FAST::Bio::AnnotationI> objects generically.
...
FAST::Bio::Seq::SeqFactory by Jason Stajich. Most credits should in fact go
to him.
...
package FAST::Bio::Annotation::AnnotationFactory;
use strict;


use base qw(FAST::Bio::Root::Root FAST::Bio::Factory::ObjectFactoryI);

=head2 new

 Title   : new
 Usage   : my $obj = FAST::Bio::Annotation::AnnotationFactory->new();
 Function: Builds a new FAST::Bio::Annotation::AnnotationFactory object 
 Returns : FAST::Bio::Annotation::AnnotationFactory
 Args    : -type => string, name of a L<FAST::Bio::AnnotationI> derived class.
...
=head2 create_object
 ...
 Function: Instantiates new FAST::Bio::AnnotationI (or one of its child classes)

           This object allows us to genericize the instantiation of
           cluster objects.

 Returns : L<FAST::Bio::AnnotationI> compliant object
...
sub create_object {
   ...
   if(! $type) {
       ...
       if($@) {
           $self->throw("FAST::Bio::AnnotationI implementation $type ".
                "failed to load: ".$@);
       }
       }
   }
...
=head2 type
 ...
 Function: Get/set the type of L<FAST::Bio::AnnotationI> object to be created.
...
sub type{
    ...
    if($type && (! $self->{'_loaded_types'}->{$type})) {
        ...
        my $a = bless {},$type;
        if( ! $a->isa('FAST::Bio::AnnotationI') ) {
        $self->throw("'$type' does not implement FAST::Bio::AnnotationI. ".
                 "Too bad.");
        }
        $self->{'_loaded_types'}->{$type} = 1;
    }
...
=head2 _guess_type
 ...
 Title   : _guess_type
 Usage   :
 Function: Guesses the right type of L<FAST::Bio::AnnotationI> implementation
