#
# BioPerl module for FAST::Bio::Annotation::TypeManager
#
...
=head1 SYNOPSIS
    ...
    $tm = FAST::Bio::Annotation::TypeManager->new();

    # $key is a string or a FAST::Bio::Ontology::TermI compliant object
...
package FAST::Bio::Annotation::TypeManager;
use strict;
...
# new() can be inherited from FAST::Bio::Root::Root
...
sub new{
   ...
   $self->_add_type_map('reference',"FAST::Bio::Annotation::Reference");
   $self->_add_type_map('comment',"FAST::Bio::Annotation::Comment");
   $self->_add_type_map('dblink',"FAST::Bio::Annotation::DBLink");
...
sub type_for_key{
   ...
   $key = $key->name() if ref($key) && $key->isa("FAST::Bio::Ontology::TermI");
