#
# BioPerl module for FAST::Bio::DB::Taxonomy::flatfile
#
...
package FAST::Bio::DB::Taxonomy::flatfile;
...
use base qw(FAST::Bio::DB::Taxonomy);
...
=head2 FAST::Bio::DB::Taxonomy Interface implementation
