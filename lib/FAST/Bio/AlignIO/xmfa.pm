#
# BioPerl module for FAST::Bio::AlignIO::xmfa
#
...
This object can transform L<FAST::Bio::SimpleAlign> objects from
...
sub _process_seq {
    ...
    my $seqobj = FAST::Bio::LocatableSeq->new(
					-nowarnonempty => 1,
					-strand      => $strand,
					-seq         => $seq,
					-display_id  => $seqname,
