#
# BioPerl module for FAST::Bio::AlignIO::stockholm
#
#   Based on the FAST::Bio::SeqIO::stockholm module
...
This object can transform L<FAST::Bio::Align::AlignI> objects to and from
...
package FAST::Bio::AlignIO::stockholm;
use strict;

use FAST::Bio::Seq::Meta;
use FAST::Bio::AlignIO::Handler::GenericAlignHandler;
...
sub _initialize {
    ...
    $self->alignhandler(FAST::Bio::AlignIO::Handler::GenericAlignHandler->new(
                    -format => 'stockholm',
...
sub write_aln {
    ...
    my ($self, @aln) = @_;
    for my $aln (@aln) {
    $self->throw('Need FAST::Bio::Align::AlignI object')
