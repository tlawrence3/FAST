#
# BioPerl module for FAST::Bio::Tools::Genomewise
#
...
=head1 SYNOPSIS
  ...
  use FAST::Bio::Tools::Genomewise;
  my $gw = FAST::Bio::Tools::Genomewise(-file=>"genomewise.out");
...
FAST::Bio::SeqFeature::Gene::GeneStructure object.  You will need to specify
...
package FAST::Bio::Tools::Genomewise;
use vars qw($Srctag);
use strict;
...
use base qw(FAST::Bio::Tools::Genewise);
...
=head2 new
 ...
 Example :
 Returns : L<FAST::Bio::Tools::Genomewise>
...
sub next_prediction {
	...
	if( /^Gene\s+\d+\s*$/ ) {
	    $genes = FAST::Bio::SeqFeature::Gene::GeneStructure->new
		(-source => $Srctag,
