#
# BioPerl module for FAST::Bio::Factory::SequenceStreamI
#
...
FAST::Bio::PrimarySeqI objects or processes FAST::Bio::PrimarySeqI objects to a
data stream.
...
package FAST::Bio::Factory::SequenceStreamI;
use strict;
