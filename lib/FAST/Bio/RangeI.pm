...
sub overlaps {
	...
	$self->throw("not a FAST::Bio::RangeI object") unless defined $other &&
	  $other->isa('FAST::Bio::RangeI');
...
sub contains {
	...
	if(defined $other && ref $other) { # a range object?
      $other->throw("Not a FAST::Bio::RangeI object: $other") unless  $other->isa('FAST::Bio::RangeI');
      $other->throw("start is undefined") unless defined $other->start;
      $other->throw("end is undefined") unless defined $other->end;
...
sub equals {
    ...
    $self->throw("start is undefined") unless defined $self->start;
    $self->throw("end is undefined") unless defined $self->end;
    $other->throw("Not a FAST::Bio::RangeI object") unless  $other->isa('FAST::Bio::RangeI');
    $other->throw("start is undefined") unless defined $other->start;
    $other->throw("end is undefined") unless defined $other->end;
...
sub intersection {
    ...
    while (@ranges > 0) {
        unless ($intersect) {
            ...
            $self->throw("Not a FAST::Bio::RangeI object: $intersect") unless $intersect->isa('FAST::Bio::RangeI');
        ...
        $self->throw("Not a FAST::Bio::RangeI object: $compare") unless $compare->isa('FAST::Bio::RangeI');
...
sub overlap_extent{
	...
	$b->throw("Not a FAST::Bio::RangeI object") unless  $b->isa('FAST::Bio::RangeI');
...
deprecated; use $self instead");
    ...
    $range->throw("Input a FAST::Bio::RangeI object") unless
$range->isa('FAST::Bio::RangeI');
