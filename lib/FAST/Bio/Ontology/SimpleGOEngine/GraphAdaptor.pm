...
#
# BioPerl Graph adaptor for FAST::Bio::Ontology::SimpleGOEngine
#
...
beyond) within FAST::Bio::Ontology::SimpleGOEngine.
...
package FAST::Bio::Ontology::SimpleGOEngine::GraphAdaptor;

use Graph::Directed;

use strict;
use FAST::Bio::Ontology::SimpleGOEngine::GraphAdaptor02;
...
sub new {
  ...
  my $self=
    ( defined $Graph::VERSION && $Graph::VERSION >= 0.5 ) ?
      bless ( {}, $class ) :
	bless ( {}, 'FAST::Bio::Ontology::SimpleGOEngine::GraphAdaptor02' );
