...
=head1 SYNOPSIS
    ...
    # FAST::Bio::Ontology::Relationship
...
package FAST::Bio::Ontology::RelationshipI;
use strict;
...
=head2 subject_term
 ...
 Returns : The subject term [FAST::Bio::Ontology::TermI].
 Args    : 
...
=head2 object_term
 ...
 Returns : The object term [FAST::Bio::Ontology::TermI].
 Args    : 
...
=head2 predicate_term
 ...
 Returns : The relationship type [FAST::Bio::Ontology::TermI].
 Args    : 
...
=head2 ontology
 ...
 Function: Get the ontology that defined (is the scope for) this
           relationship.
 Example : 
 Returns : an object implementing FAST::Bio::Ontology::OntologyI
 Args    : 
