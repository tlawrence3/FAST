#
# BioPerl module for FAST::Bio::Ontology::OBOEngine
#
...
=head1 SYNOPSIS
  ...
  use FAST::Bio::Ontology::OBOEngine;

  my $parser = FAST::Bio::Ontology::OBOEngine->new
...
package FAST::Bio::Ontology::OBOEngine;

use FAST::Bio::Ontology::SimpleGOEngine::GraphAdaptor;

use strict;
use FAST::Bio::Ontology::RelationshipType;
use FAST::Bio::Ontology::RelationshipFactory;
use Data::Dumper;
...
use base qw(FAST::Bio::Root::Root FAST::Bio::Ontology::OntologyEngineI);
...
=head2 new
 ...
 Title   : new
 Usage   : $engine = FAST::Bio::Ontology::OBOEngine->new()
...
sub init {
    ...
    $self->{ "_is_a_relationship" }       = FAST::Bio::Ontology::RelationshipType->get_instance( IS_A );
    $self->{ "_part_of_relationship" }    = FAST::Bio::Ontology::RelationshipType->get_instance( PART_OF );
    $self->{ "_related_to_relationship" } = FAST::Bio::Ontology::RelationshipType->get_instance( RELATED_TO );

    $self->{'_regulates_relationship'} = FAST::Bio::Ontology::RelationshipType->get_instance(REGULATES);
    $self->{'_positively_regulate'} = FAST::Bio::Ontology::RelationshipType->get_instance(POSITIVELY_REGULATES);
    $self->{'_negatively_regulate'} = FAST::Bio::Ontology::RelationshipType->get_instance(NEGATIVELY_REGULATES);
    

    $self->graph( FAST::Bio::Ontology::SimpleGOEngine::GraphAdaptor->new() );        # NG 05-02-16

    # set defaults for the factories
    $self->relationship_factory(FAST::Bio::Ontology::RelationshipFactory->new(
                                     -type => "FAST::Bio::Ontology::Relationship"));
...
=head2 is_a_relationship
 ...
 Function: Returns a FAST::Bio::Ontology::RelationshipType object for "is-a"
           relationships
 Returns : FAST::Bio::Ontology::RelationshipType set to "IS_A"
 Args    :
...
=head2 part_of_relationship
 ...
 Function: Returns a FAST::Bio::Ontology::RelationshipType object for "part-of"
           relationships
 Returns : FAST::Bio::Ontology::RelationshipType set to "PART_OF"
 Args    :
...
=head2 related_to_relationship
 ...
 Function: Returns a FAST::Bio::Ontology::RelationshipType object for "related-to"
           relationships
 Returns : FAST::Bio::Ontology::RelationshipType set to "RELATED_TO"
 Args    :
...
=head2 regulates_relationship
 ...
 Function: Returns a FAST::Bio::Ontology::RelationshipType object for "regulates"
           relationships
 Returns : FAST::Bio::Ontology::RelationshipType set to "REGULATES"
 Args    :
...
=head2 positively_regulates_relationship
 ...
 Function: Returns a FAST::Bio::Ontology::RelationshipType object for "positively_regulates"
           relationships
 Returns : FAST::Bio::Ontology::RelationshipType set to "POSITIVELY_REGULATES"
 Args    :
...
=head2 negatively_regulates_relationship
 ...
 Function: Returns a FAST::Bio::Ontology::RelationshipType object for "negatively_regulates"
           relationships
 Returns : FAST::Bio::Ontology::RelationshipType set to "POSITIVELY_REGULATES"
 Args    :
...
sub add_relationship_type{
   ...
   if(scalar(@_) == 3){
         my $type_name = $args[0];
         my $ont = $args[1];
         $self->{ "_extra_relationship_types" }{$type_name} = FAST::Bio::Ontology::RelationshipType->get_instance($type_name,$ont);
...
=head2 get_relationship_type
 ...
 Function: Gets a FAST::Bio::Ontology::RelationshipI object corresponding
           to $type_name
 Returns : a FAST::Bio::Ontology::RelationshipI object
 Args    :
...
=head2 add_relationship
 ...
 Args    : The relationship in one of three ways:
             ...
             a) subject (or child) term id, FAST::Bio::Ontology::TermI
                (rel.type), object (or parent) term id, ontology

           or

             b) subject FAST::Bio::Ontology::TermI, predicate
                FAST::Bio::Ontology::TermI (rel.type), object
                FAST::Bio::Ontology::TermI, ontology

           or

             c) FAST::Bio::Ontology::RelationshipI-compliant object
...
sub add_relationship {
    ...
    if ( scalar( @_ ) == 2 ) {
        $self->_check_class( $child, "FAST::Bio::Ontology::RelationshipI" );
    ...
    $self->_check_class( $type, "FAST::Bio::Ontology::TermI" );
...
=head2 get_predicate_terms
 ...
 Returns : FAST::Bio::Ontology::RelationshipType
 Args    :
...
=head2 get_child_terms
 ...
 Returns : FAST::Bio::Ontology::TermI
 Args    : FAST::Bio::Ontology::TermI, FAST::Bio::Ontology::RelationshipType
           or
           term id, FAST::Bio::Ontology::RelationshipType

           if NO FAST::Bio::Ontology::RelationshipType is indicated: children
...
=head2 get_descendant_terms
 ...
 Args    : FAST::Bio::Ontology::TermI, FAST::Bio::Ontology::RelationshipType
           ...
           if NO FAST::Bio::Ontology::RelationshipType is indicated:
...
=head2 get_terms
 ...
 Returns : FAST::Bio::Ontology::TermI, or the term corresponding to the
...
=head2 find_terms
 ...
 Example :
 Returns : an array of zero or more FAST::Bio::Ontology::TermI objects
...
=head2 find_identically_named_terms
 ...
 Example :
 Returns : an array of zero or more FAST::Bio::Ontology::TermI objects
 Args    : a FAST::Bio::Ontology::TermI object

=cut

sub find_identically_named_terms{
    my ($self,$qterm) = @_;
    $self->throw("Argument doesn't implement FAST::Bio::Ontology::TermI. " . "Bummer." )
        unless defined $qterm and $qterm->isa("FAST::Bio::Ontology::TermI");
...
=head2 relationship_factory
 ...
 Example :
 Returns : value of relationship_factory (a FAST::Bio::Factory::ObjectFactoryI
           compliant object)
 Args    : on set, a FAST::Bio::Factory::ObjectFactoryI compliant object
...
=head2 term_factory
 ...
 Example :
 Returns : value of term_factory (a FAST::Bio::Factory::ObjectFactoryI
           compliant object)
 Args    : on set, a FAST::Bio::Factory::ObjectFactoryI compliant object
...
sub graph {
    ...
    if ( defined $value ) {
        $self->_check_class( $value, 'FAST::Bio::Ontology::SimpleGOEngine::GraphAdaptor' ); # NG 05-02-16
        $self->{ "_graph" } = $value;
    }
...
sub _get_id {
    ...
    if ( ref($term) ) {
        ...
        $self->throw(
            "Object doesn't implement FAST::Bio::Ontology::TermI. " . "Bummer." )
          unless $term->isa("FAST::Bio::Ontology::TermI");
        $id = $term->identifier();
...
#        if $term->isa("FAST::Bio::Ontology::GOterm")||($id =~ /^[A-Z_]{1,8}:\d{1,}$/);
      if $term->isa("FAST::Bio::Ontology::OBOterm") || ( $id =~ /^\w+:\w+$/ );
