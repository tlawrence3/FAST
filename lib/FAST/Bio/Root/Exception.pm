...
=head2 Defining a new Exception type as a subclass of FAST::Bio::Root::Exception:
...
base class exception, FAST::Bio::Root::Exception. This allows a user to
...
from FAST::Bio::Root::Exception directly, or indirectly by inheriting from a
FAST::Bio::Root::Exception subclass.

The exceptions in FAST::Bio::Root::Exception are extensions of Graham Barr's
L<Error> module available from CPAN.  Despite this dependency, the
L<FAST::Bio::Root::Exception> module does not explicitly C<require Error>.
This permits FAST::Bio::Root::Exception to be loaded even when
...
=head2 L<FAST::Bio::Root::Exception>
...
#---------------------------------------------------------
@FAST::Bio::Root::Exception::ISA = qw( Error );
#---------------------------------------------------------

=head1 Methods defined by FAST::Bio::Root::Exception
...
#---------------------------------------------------------
@FAST::Bio::Root::NotImplemented::ISA = qw( FAST::Bio::Root::Exception );
#---------------------------------------------------------
...
#---------------------------------------------------------
@FAST::Bio::Root::IOException::ISA = qw( FAST::Bio::Root::Exception );
#---------------------------------------------------------
...
#---------------------------------------------------------
@FAST::Bio::Root::FileOpenException::ISA = qw( FAST::Bio::Root::IOException );
#---------------------------------------------------------
...
#---------------------------------------------------------
@FAST::Bio::Root::SystemException::ISA = qw( FAST::Bio::Root::Exception );
#---------------------------------------------------------
...
#---------------------------------------------------------
@FAST::Bio::Root::BadParameter::ISA = qw( FAST::Bio::Root::Exception );
#---------------------------------------------------------
...
#---------------------------------------------------------
@FAST::Bio::Root::OutOfRange::ISA = qw( FAST::Bio::Root::Exception );
#---------------------------------------------------------
