#
# BioPerl module for FAST::Bio::Location::FuzzyLocationI
...
package FAST::Bio::Location::FuzzyLocationI;
use strict;

use base qw(FAST::Bio::LocationI);
...
=head1 FAST::Bio::LocationI methods
