#
# BioPerl module for FAST::Bio::Location::CoordinatePolicyI
...
=head1 SYNOPSIS
    ...
    $location->coordinate_policy(FAST::Bio::Location::NarrowestCoordPolicy->new());

=head1 DESCRIPTION

Objects implementing this interface are used by FAST::Bio::LocationI
...
package FAST::Bio::Location::CoordinatePolicyI;
use strict;
