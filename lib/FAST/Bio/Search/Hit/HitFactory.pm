#
# BioPerl module for FAST::Bio::Search::Hit::HitFactory
#
...
=head1 SYNOPSIS
    ...
    my $factory = FAST::Bio::Search::Hit::HitFactory->new();
...
package FAST::Bio::Search::Hit::HitFactory;
...
BEGIN { 
    $DEFAULT_TYPE = 'FAST::Bio::Search::Hit::GenericHit'; 
}

=head2 new

 Title   : new
 Usage   : my $obj = FAST::Bio::Search::Hit::HitFactory->new();
 Function: Builds a new FAST::Bio::Search::Hit::HitFactory object 
 Returns : FAST::Bio::Search::Hit::HitFactory
 Args    :
...
=head2 create
 ...
 Function: Create a new L<FAST::Bio::Search::Hit::HitI> object  
 Returns : L<FAST::Bio::Search::Hit::HitI>
...
=head2 type
 ...
 Title   : type
 Usage   : $factory->type('FAST::Bio::Search::Hit::GenericHit');
