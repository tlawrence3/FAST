#
# BioPerl module for FAST::Bio::Search::Hit::GenericHit
#
...
=head1 SYNOPSIS
    ...
    use FAST::Bio::Search::Hit::GenericHit;
    my $hit = FAST::Bio::Search::Hit::GenericHit->new(-algorithm => 'blastp');

    # typically one gets HitI objects from a SearchIO stream via a ResultI
    use FAST::Bio::SearchIO;
    my $parser = FAST::Bio::SearchIO->new(-format => 'blast', -file => 'result.bls');
...
a SearchIO stream which returns FAST::Bio::Search::Hit::HitI objects.

For documentation on what you can do with GenericHit (and other HitI
objects), please see the API documentation in
L<FAST::Bio::Search::Hit::HitI|FAST::Bio::Search::Hit::HitI>.
...
package FAST::Bio::Search::Hit::GenericHit;
use strict;

use FAST::Bio::Search::SearchUtils;

use base qw(FAST::Bio::Root::Root FAST::Bio::Search::Hit::HitI);

=head2 new

 Title   : new
 Usage   : my $obj = FAST::Bio::Search::Hit::GenericHit->new();
 Function: Builds a new FAST::Bio::Search::Hit::GenericHit object 
 Returns : FAST::Bio::Search::Hit::GenericHit
 Args    : -name         => Name of Hit (required)
           ...
           -hsp_factory  => FAST::Bio::Factory::ObjectFactoryI able to create HSPI
                            objects.
...
=head2 add_hsp
 ...
 Args    : FAST::Bio::Search::HSP::HSPI object, OR hash ref containing data suitable
...
sub add_hsp {
   my ($self,$hsp) = @_;
   if (!defined $hsp || (ref($hsp) ne 'HASH' && !$hsp->isa('FAST::Bio::Search::HSP::HSPI'))) { 
       $self->throw("Must provide a valid FAST::Bio::Search::HSP::HSPI object or hash ref to object: $self method: add_hsp value: $hsp");
       return;
   }
...
=head2 hsp_factory
 ...
 Returns : FAST::Bio::Factory::ObjectFactoryI
 Args    : FAST::Bio::Factory::ObjectFactoryI
...
=head2 FAST::Bio::Search::Hit::HitI methods

Implementation of FAST::Bio::Search::Hit::HitI methods
...
=head2 next_hsp
 ...
 Example  : 
 Returns  : FAST::Bio::Search::HSP::HSPI object or null if finished
 Args     : none
...
=head2 hsps
 ...
 Returns   : Array context : list of FAST::Bio::Search::HSP::BlastHSP.pm objects.
...
See documentation in L<FAST::Bio::Search::Hit::HitI::overlap()|FAST::Bio::Search::Hit::HitI>
...
See Also   : L<expect()|expect>, L<significance()|significance>, L<FAST::Bio::Search::SearchUtils::get_exponent()|FAST::Bio::Search::SearchUtils>
...
# Some duplication of logic for p(), expect() and signif() for the sake of performance.
    ...
    return &FAST::Bio::Search::SearchUtils::get_exponent($val) if $fmt =~ /^exp/i;
...
=head2 hsp
 ...
 Returns   : Object reference for a FAST::Bio::Search::HSP::BlastHSP.pm object.
...
sub logical_length {
    ...
    $logical = FAST::Bio::Search::SearchUtils::logical_length($algo, $seqType, $length);
...
See Also   : L<length()|length>, L<frac_aligned_query()|frac_aligned_query>, L<frac_aligned_hit()|frac_aligned_hit>, L<gaps()|gaps>, L<FAST::Bio::Search::SearchUtils::tile_hsps()|FAST::Bio::Search::SearchUtils>, L<FAST::Bio::Search::HSP::BlastHSP::length()|FAST::Bio::Search::HSP::BlastHSP>
...
sub length_aln {
    ...
    unless ($self->{'_hsps'}) {
        #return wantarray ? ('-','-') : '-';
        FAST::Bio::Search::SearchUtils::_warn_about_no_hsps($self);
        return '-';
    }

    FAST::Bio::Search::SearchUtils::tile_hsps($self) unless $self->tiled_hsps;
...
See documentation in L<FAST::Bio::Search::Hit::HitI::matches()|FAST::Bio::Search::Hit::HitI>
...
See Also   : L<end()|end>, L<range()|range>, L<strand()|strand>, 
             L<FAST::Bio::Search::HSP::BlastHSP::start|FAST::Bio::Search::HSP::BlastHSP>
...
See Also   : L<frac_conserved()|frac_conserved>, L<frac_aligned_query()|frac_aligned_query>, L<matches()|matches>, L<FAST::Bio::Search::SearchUtils::tile_hsps()|FAST::Bio::Search::SearchUtils>
...
See Also   : L<frac_identical()|frac_identical>, L<matches()|matches>, L<FAST::Bio::Search::SearchUtils::tile_hsps()|FAST::Bio::Search::SearchUtils>
...
See Also   : L<frac_aligned_hit()|frac_aligned_hit>, L<logical_length()|logical_length>, L<length_aln()|length_aln>,  L<FAST::Bio::Search::SearchUtils::tile_hsps()|FAST::Bio::Search::SearchUtils>
...
See Also   : L<frac_aligned_query()|frac_aligned_query>, L<matches()|matches>, , L<logical_length()|logical_length>, L<length_aln()|length_aln>,  L<FAST::Bio::Search::SearchUtils::tile_hsps()|FAST::Bio::Search::SearchUtils>
...
See Also   : L<num_unaligned_query()|num_unaligned_query>,  L<FAST::Bio::Search::SearchUtils::tile_hsps()|FAST::Bio::Search::SearchUtils>, L<frac_aligned_hit()|frac_aligned_hit>
...
See Also   : L<num_unaligned_hit()|num_unaligned_hit>, L<frac_aligned_query()|frac_aligned_query>,  L<FAST::Bio::Search::SearchUtils::tile_hsps()|FAST::Bio::Search::SearchUtils>
...
See Also   : L<FAST::Bio::Search::HSP::BlastHSP::seq_inds()|FAST::Bio::Search::HSP::BlastHSP>
...
sub seq_inds {
    ...
    $collapse ?  &FAST::Bio::Search::SearchUtils::collapse_nums(@inds) : @inds; 
}


=head2 strand

See documentation in L<FAST::Bio::Search::Hit::HitI::strand()|FAST::Bio::Search::Hit::HitI>
...
See documentation in L<FAST::Bio::Search::Hit::HitI::frame()|FAST::Bio::Search::Hit::HitI>
...
See documentation in L<FAST::Bio::Search::SearchUtils::tile_hsps()|FAST::Bio::Search::SearchUtils>
...
=head2 sort_hits
 ...
 Note		: To access the special variables $a and $b used by the Perl sort() function 
                  the user function must access FAST::Bio::Search::Hit::HitI namespace. 
                  For example, use :
                  $hit->sort_hsps( sub{$FAST::Bio::Search::Result::HitI::a->length <=> 
					  $FAST::Bio::Search::Result::HitI::b->length});
