#
# BioPerl module for FAST::Bio::Search::Result::ResultFactory
#
...
=head1 SYNOPSIS
    ...
    my $factory = FAST::Bio::Search::Result::ResultFactory->new();
...
package FAST::Bio::Search::Result::ResultFactory;
...
BEGIN { 
    $DEFAULT_TYPE = 'FAST::Bio::Search::Result::GenericResult'; 
}

=head2 new

 Title   : new
 Usage   : my $obj = FAST::Bio::Search::Result::ResultFactory->new();
 Function: Builds a new FAST::Bio::Search::Result::ResultFactory object 
 Returns : FAST::Bio::Search::Result::ResultFactory
 Args    :
...
=head2 create
 ...
 Function: Create a new L<FAST::Bio::Search::Result::ResultI> object  
...
=head2 type
 ...
 Title   : type
 Usage   : $factory->type('FAST::Bio::Search::Result::GenericResult');
