#
# BioPerl module for FAST::Bio::Search::Result::BlastPullResult
#
...
package FAST::Bio::Search::Result::BlastPullResult;

use strict;

use FAST::Bio::Search::Hit::BlastPullHit;

use base qw(FAST::Bio::Root::Root FAST::Bio::Search::Result::PullResultI);
...
sub _discover_next_hit {
	...
	#    ourselves
	$self->_fields->{next_hit} = FAST::Bio::Search::Hit::BlastPullHit->new(-parent => $self,
