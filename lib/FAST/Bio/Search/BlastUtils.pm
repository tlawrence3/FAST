...
See L<FAST::Bio::Search::Hit::BlastHit>.

=head1 DESCRIPTION

The BlastUtils.pm module is a collection of subroutines used primarily by
FAST::Bio::Search::Hit::BlastHit objects for some of the additional
...
FAST::Bio::Search::Hit::BlastHit. A goal for the future is to generalize it
to work based on the FAST::Bio::Search interfaces, then it can work with any
...
package FAST::Bio::Search::BlastUtils;
...
=head2 tile_hsps
 ...
 Usage     : tile_hsps( $sbjct );
           : This is called automatically by FAST::Bio::Search::Hit::BlastHit 
 ...
 Returns   : n/a
 Argument  : A FAST::Bio::Search::Hit::BlastHit object 
 Throws    : n/a
 Comments  :
 	   : This method is *strongly* coupled to FAST::Bio::Search::Hit::BlastHit
 	   : (it accesses BlastHit data members directly).
 	   : TODO: Re-write this to the FAST::Bio::Search::Hit::HitI interface.
 	   :
 ...
 Bugs      : Currently, tile_hsps() does not properly account for
           ...
           : Ambiguous Alignments" section in L<FAST::Bio::Search::Hit::BlastHit>.

See Also   : L<_adjust_contigs>(), L<FAST::Bio::Search::Hit::BlastHit|FAST::Bio::Search::Hit::BlastHit>
...
=head2 _adjust_contigs
 ...
 Returns   : 
 Argument  : 
 Throws    : Exceptions propagated from FAST::Bio::Search::Hit::BlastHSP::matches()
...
See Also   : L<tile_hsps>(), L<FAST::Bio::Search::Hit::BlastHSP::matches|FAST::Bio::Search::Hit::BlastHSP>
...
See Also   : L<FAST::Bio::Search::Hit::BlastHit::seq_inds()|FAST::Bio::Search::Hit::BlastHit>
...
=head2 strip_blast_html
 ...
 Purpose   : Removes HTML formatting from a supplied string.
           ...
           : parsing by FAST::Bio::SearchIO::blast.pm
