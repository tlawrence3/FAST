#
# BioPerl module for FAST::Bio::Search::HSP::GenericHSP
#
...
=head1 SYNOPSIS
    ...
    my $hsp = FAST::Bio::Search::HSP::GenericHSP->new( -algorithm => 'blastp',
                                                -evalue    => '1e-30',
                                                );
...
a SearchIO stream which returns FAST::Bio::Search::Result::ResultI objects
...
L<FAST::Bio::Search::HSP::HSPI|FAST::Bio::Search::HSP::HSPI>.
...
package FAST::Bio::Search::HSP::GenericHSP;
use strict;

use FAST::Bio::Root::Root;
use FAST::Bio::SeqFeature::Similarity;

use base qw(FAST::Bio::Search::HSP::HSPI);

=head2 new

 Title   : new
 Usage   : my $obj = FAST::Bio::Search::HSP::GenericHSP->new();
 Function: Builds a new FAST::Bio::Search::HSP::GenericHSP object
 Returns : FAST::Bio::Search::HSP::GenericHSP
...
=head2 L<FAST::Bio::Search::HSP::HSPI> methods

Implementation of L<FAST::Bio::Search::HSP::HSPI> methods follow
...
# above; this is also consistent with FAST::Bio::SeqFeature::SimilarityPair).  Also,
...
sub frame {
    ...
    if (!defined $val) {
        ...
        $self->warn("API for frame() has changed.\n".
                    "Please refer to documentation for FAST::Bio::Search::HSP::GenericHSP;\n".
...
=head2 get_aln
 ...
 Function: Returns a L<FAST::Bio::SimpleAlign> object representing the HSP alignment
 Returns : L<FAST::Bio::SimpleAlign>
 Args    : none
...
sub get_aln {
    my ($self) = @_;
    require FAST::Bio::LocatableSeq;
    require FAST::Bio::SimpleAlign;
    ...
    my $query = FAST::Bio::LocatableSeq->new('-seq'   => $qs,
                                      '-id'    => $q_nm,
    ...
    $seqonly = $hs;
    $seqonly =~ s/[\-\s]//g;
    my $hit =  FAST::Bio::LocatableSeq->new('-seq'    => $hs,
                                      '-id'    => $s_nm,
...
=head2 seq_inds
 ...
 Comments  : For HSPs partially or completely derived from translated sequences
           ...
           :
See Also   : L<FAST::Bio::Search::SearchUtils::collapse_nums()|FAST::Bio::Search::SearchUtils>,
             L<FAST::Bio::Search::Hit::HitI::seq_inds()|FAST::Bio::Search::Hit::HitI>
...
sub seq_inds{
   ...
   require FAST::Bio::Search::BlastUtils if $collapse;

   return $collapse ? &FAST::Bio::Search::SearchUtils::collapse_nums(@ary) : @ary;
}
...
See Also   : L<FAST::Bio::Search::Hit::HSPI::seq_inds()>
...
sub feature1 {
    ...
    if (! $self->{_finished_new} || $self->{_making_qff}) {
        ...
        $self->{_sim1} = FAST::Bio::SeqFeature::Similarity->new();
        return $self->{_sim1};
    }
    unless ($self->{_created_qff}) {
        $self->_query_seq_feature;
...
sub feature2 {
    ...
    if (! $self->{_finished_new} || $self->{_making_sff}) {
        ...
        $self->{_sim2} = FAST::Bio::SeqFeature::Similarity->new();
        return $self->{_sim2};
    }
    unless ($self->{_created_sff}) {
        $self->_subject_seq_feature;
...
See documentation in L<FAST::Bio::Search::HSP::HSPI::n()|FAST::Bio::Search::HSP::HSPI>
...
See documentation in L<FAST::Bio::Search::HSP::HSPI::range()|FAST::Bio::Search::HSP::HSPI>
...
=head2 generate_cigar_string
  ...
  Usage:    my $cigar_string = FAST::Bio::Search::HSP::GenericHSP::generate_cigar_string ($qstr, $hstr);
...
sub _query_seq_feature {
    ...
    my $sim1 = $self->{_sim1} || FAST::Bio::SeqFeature::Similarity->new();
    $sim1->start($qs);
    $sim1->end($qe);
...
sub _subject_seq_feature {
    ...
    my $sim2 = $self->{_sim2} || FAST::Bio::SeqFeature::Similarity->new();
    $sim2->start($hs);
    $sim2->end($he);
