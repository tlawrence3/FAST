#
# BioPerl module for FAST::Bio::Search::HSP::PullHSPI
#
...
that use FAST::Bio::PullParserI. It only really makes sense for PullHSP modules to be
...
package FAST::Bio::Search::HSP::PullHSPI;


use strict;

use base qw(FAST::Bio::Search::HSP::HSPI FAST::Bio::PullParserI);
