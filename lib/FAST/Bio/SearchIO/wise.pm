#
# BioPerl module for FAST::Bio::SearchIO::wise
#
...
=head1 SYNOPSIS
  ...
  my $parser = FAST::Bio::SearchIO->new(-file    => 'file.genewise', 
                                 -format  => 'wise',
                                 -wisetype=> 'genewise');
...
This object parsers Wise output using FAST::Bio::Tools::Genewise or
FAST::Bio::Tools::Genomewise as a helper.
...
package FAST::Bio::SearchIO::wise;
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = FAST::Bio::SearchIO::wise->new();
 Function: Builds a new FAST::Bio::SearchIO::wise object 
 Returns : an instance of FAST::Bio::SearchIO::wise
 Args    : -wise => a FAST::Bio::Tools::Genewise or FAST::Bio::Tools::Genomewise object
...
sub _initialize {
	...
	$self->wise(FAST::Bio::Tools::Genewise->new(@ioargs));
    } elsif( $wisetype =~ /genomewise/i ) {
	$self->wise(FAST::Bio::Tools::Genomewise->new(@ioargs));
    } else { 
