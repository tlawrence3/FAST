#
# BioPerl module for FAST::Bio::SearchIO::blast
#
...
=head1 SYNOPSIS
   ...
   # FAST::Bio::SearchIO system.

    use FAST::Bio::SearchIO;
    my $searchio = FAST::Bio::SearchIO->new(-format => 'blast',
...
suitable for building FAST::Bio::Search objects from a BLAST report file.
Read the L<FAST::Bio::SearchIO> for more information about how to use this.
...
constructor i.e.
  ...
  my $parser = FAST::Bio::SearchIO->new(-format => 'blast',
...
package FAST::Bio::SearchIO::blast;
...
BEGIN {
    ...
    $DEFAULT_BLAST_WRITER_CLASS = 'FAST::Bio::SearchIO::Writer::HitTableWriter';
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = FAST::Bio::SearchIO::blast->new(%args);
 ...
 Args    : Key-value pairs:
           ...
           -hit_filter  => reference to a function to be used for
                           ...
                           FAST::Bio::Search::Hit::BlastHit.pm object as its first
...
sub start_element {
    ...
    if ($type) {
        ...
        if ($handler) {
            ...
            #    "FAST::Bio::SearchIO::InternalParserError ".
