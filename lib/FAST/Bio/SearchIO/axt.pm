#
# BioPerl module for FAST::Bio::SearchIO::axt
#
...
=head1 SYNOPSIS
  ...
  my $parser = FAST::Bio::SearchIO->new(-format => 'axt',
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = FAST::Bio::SearchIO::axt->new();
 Function: Builds a new FAST::Bio::SearchIO::axt object 
 Returns : an instance of FAST::Bio::SearchIO::axt
 Args    :
