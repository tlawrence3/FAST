#
# BioPerl module for FAST::Bio::SearchIO::EventHandlerI
#
...
# See FAST::Bio::SearchIO::SearchResultEventBuilder for an implementation

    use FAST::Bio::SearchIO::SearchResultEventBuilder;
    my $handler = FAST::Bio::SearchIO::SearchResultEventBuilder->new();
...
package FAST::Bio::SearchIO::EventHandlerI;
use strict;
use Carp;


use base qw(FAST::Bio::Event::EventHandlerI);
...
=head2 end_hsp
 ...
 Returns : FAST::Bio::Search::HSP::HSPI object
...
See L<FAST::Bio::Factory::ObjectFactoryI> for more information
...
=head2 factory
 ...
 Returns : a FAST::Bio::Factory::ObjectFactoryI
 Throws  : FAST::Bio::Root::BadParameter if none registered for the supplied type
...
=head2 FAST::Bio::Event::EventHandlerI methods
...
See L<FAST::Bio::Event::EventHandlerI> for the additional SAX methods.
