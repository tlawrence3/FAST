#
# BioPerl module for FAST::Bio::SearchIO::waba
#
...
=head1 SYNOPSIS
    ...
    # do not use this object directly, rather through FAST::Bio::SearchIO

    use FAST::Bio::SearchIO;
    my $in = FAST::Bio::SearchIO->new(-format => 'waba',
			       -file   => 'output.wab');
...
package FAST::Bio::SearchIO::waba;
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = FAST::Bio::SearchIO::waba->new();
 Function: Builds a new FAST::Bio::SearchIO::waba object 
 Returns : FAST::Bio::SearchIO::waba
 Args    : see FAST::Bio::SearchIO
...
sub _initialize {
    ...
    $self->_eventHandler->register_factory('result', FAST::Bio::Search::Result::ResultFactory->new(-type => 'FAST::Bio::Search::Result::WABAResult'));

    $self->_eventHandler->register_factory('hsp', FAST::Bio::Search::HSP::HSPFactory->new(-type => 'FAST::Bio::Search::HSP::WABAHSP'));
}
