...
=head2 Example 1: Using the default columns
    ...
    use FAST::Bio::SearchIO::Writer::HSPTableWriter;

    my $in = FAST::Bio::SearchIO->new();

    my $writer = FAST::Bio::SearchIO::Writer::HSPTableWriter->new();
...
FAST::Bio::SearchIO::Writer::HSPTableWriter generates output at the finest
...
corresponding method in FAST::Bio::Search::HSP::HSPI.
...
=head1 SEE ALSO
    ...
    FAST::Bio::SearchIO::Writer::ResultTableWriter

=head1 METHODS

=cut

package FAST::Bio::SearchIO::Writer::HSPTableWriter;
...
# Methods for result object are defined in FAST::Bio::Search::Result::ResultI.
# Methods for hit object are defined in FAST::Bio::Search::Hit::HitI.
# Methods for hsp object are defined in FAST::Bio::Search::HSP::HSPI.
