#
# BioPerl module for FAST::Bio::SearchIO::Writer::TextResultWriter
#
...
a set of Text for a specific FAST::Bio::Search::Report::ReportI interface.
...
expects to be passed an object - one of FAST::Bio::Search::HSP::HSPI,
FAST::Bio::Search::Hit::HitI, and FAST::Bio::Search::Result::ResultI respectively.
...
See L<FAST::Bio::SearchIO::SearchWriterI> for more info on the filter method.
...
FAST::Bio::SearchIO::Writer::TextResultWriter(-verbose =E<gt> -1);
...
package FAST::Bio::SearchIO::Writer::TextResultWriter;
use vars qw($MaxNameLen $MaxDescLen $AlignmentLineWidth 	    $DescLineLen $TextWrapLoaded);
use strict;

# Object preamble - inherits from FAST::Bio::Root::RootI
...
use base qw(FAST::Bio::Root::Root FAST::Bio::SearchIO::SearchWriterI);
...
# copied from FAST::Bio::Index::Fasta
# useful here as well
...
sub algorithm_reference{
   ...
   return '' if( ! defined $result || !ref($result) ||
		 ! $result->isa('FAST::Bio::Search::Result::ResultI')) ;   
...
=head2 Methods FAST::Bio::SearchIO::SearchWriterI

L<FAST::Bio::SearchIO::SearchWriterI> inherited methods.
