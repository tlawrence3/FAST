...
=head2 Example 1: Using the default columns
    ...
    use FAST::Bio::SearchIO::Writer::HitTableWriter;

    my $in = FAST::Bio::SearchIO->new();

    my $writer = FAST::Bio::SearchIO::Writer::HitTableWriter->new();
...
FAST::Bio::SearchIO::Writer::HitTableWriter outputs summary data 
...
See the docs in L<FAST::Bio::Search::Hit::BlastHit|FAST::Bio::Search::Hit::BlastHit>
...
corresponding method in FAST::Bio::Search::Result::BlastHit.
...
L<FAST::Bio::SearchIO::Writer::HitTableWriter>, 
L<FAST::Bio::SearchIO::Writer::ResultTableWriter>

=head1 METHODS

=cut

package FAST::Bio::SearchIO::Writer::HitTableWriter;

use strict;

use base qw(FAST::Bio::SearchIO::Writer::ResultTableWriter);


# Array fields: column, object, method[/argument], printf format,
# column label Methods for result object are defined in
# FAST::Bio::Search::Result::ResultI.  Methods for hit object are defined in
# FAST::Bio::Search::Hit::HitI.  Tech note: If a bogus method is supplied,
...
L<the SYNOPSIS section | SYNOPSIS>.
 ...
 Usage     : print $writer->to_string( $result_obj, [$include_labels] );
           :
 Argument  : $result_obj = A FAST::Bio::Search::Result::BlastResult object
