...
#
# BioPerl module for FAST::Bio::PrimarySeqI
#
...
=head1 SYNOPSIS
    ...
    # get a FAST::Bio::PrimarySeqI compliant object somehow

    # to test this is a seq object

    $obj->isa("FAST::Bio::PrimarySeqI") || $obj->throw("$obj does not implement the FAST::Bio::PrimarySeqI interface");
...
FAST::Bio::PrimarySeq. If you just want to use FAST::Bio::PrimarySeq objects, then
...
implementation is provided in FAST::Bio::PrimarySeq). If you want to provide
a FAST::Bio::PrimarySeq 'compliant' object which in fact wraps another
...
from your object and this FAST::Bio::PrimarySeqI interface. The wrapper class
...
package FAST::Bio::MyPrimarySeqI;
use vars qw(@ISA);
use strict;
use Carp;
...
sub seq {
   ...
   if( $self->can('throw') ) {
       $self->throw("FAST::Bio::PrimarySeqI definition of seq - implementing class did not provide this method");
   } else {
       confess("FAST::Bio::PrimarySeqI definition of seq - implementing class did not provide this method");
   }
}
...
sub subseq{
   ...
   if( $self->can('throw') ) {
       $self->throw("FAST::Bio::PrimarySeqI definition of subseq - implementing class did not provide this method");
   } else {
       confess("FAST::Bio::PrimarySeqI definition of subseq - implementing class did not provide this method");
   }
...
sub display_id {
   ...
   if( $self->can('throw') ) {
       $self->throw("FAST::Bio::PrimarySeqI definition of id - implementing class did not provide this method");
   } else {
       confess("FAST::Bio::PrimarySeqI definition of id - implementing class did not provide this method");
   }
...
sub  length {
   ...
   if( $self->can('throw') ) {
       $self->throw("FAST::Bio::PrimarySeqI definition of length - implementing class did not provide this method");
   } else {
       confess("FAST::Bio::PrimarySeqI definition of length - implementing class did not provide this method");
   }
}
...
sub desc {
   my ($self,$value) = @_;
   if( $self->can('warn') ) {
       $self->warn("FAST::Bio::PrimarySeqI definition of desc - implementing class did not provide this method");
   } else {
       warn("FAST::Bio::PrimarySeqI definition of desc - implementing class did not provide this method");
   }
   return '';
}
...
sub _attempt_to_load_Seq{
   ...
   if( $main::{'FAST::Bio::PrimarySeq'} ) {
       ...
       if( $@ ) {
	   if( $self->can('throw') ) {
	       $self->throw("FAST::Bio::PrimarySeq could not be loaded for $self\nThis indicates that you are usnig FAST::Bio::PrimarySeqI without FAST::Bio::PrimarySeq loaded and without providing a complete solution\nThe most likely problem is that there has been a misconfiguration of the bioperl environment\nActual exception\n\n$@\n");
	   } else {
	       confess("FAST::Bio::PrimarySeq could not be loaded for $self\nThis indicates that you are usnig FAST::Bio::PrimarySeqI without FAST::Bio::PrimarySeq loaded and without providing a complete solution\nThe most likely problem is that there has been a misconfiguration of the bioperl environment\nActual exception\n\n$@\n");
	   }
	   return 0;
       }
       return 1;
